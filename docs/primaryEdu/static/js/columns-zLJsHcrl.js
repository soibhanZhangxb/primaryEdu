...
var I = (e, a, n) =>
    a in e
      ? ie(e, a, { enumerable: !0, configurable: !0, writable: !0, value: n })
      : (e[a] = n),
  j = (e, a) => {
    for (var n in a || (a = {})) _e.call(a, n) && I(e, n, a[n]);
    if (D) for (var n of D(a)) oe.call(a, n) && I(e, n, a[n]);
    return e;
  };
var z = (e, a, n) =>
  new Promise((s, u) => {
    var y = t => {
      ...
      m = t => (t.done ? s(t.value) : Promise.resolve(t.value).then(y, _));
    m((n = n.apply(e, a)).next());
  });
import { a as ue } from "./data-CS1hRn5y.js";
import {
  f as se,
  d as re,
  gA as le,
...
const X = function (e) {
  ...
  if (e && typeof e == "object")
    for (let n in e)
      e.hasOwnProperty(n) &&
        (e[n] && typeof e[n] == "object" ? (a[n] = X(e[n])) : (a[n] = e[n]));
  return a;
};
var g = re({
  name: "MouseMenu",
  ...
  setup(e, { emit: a }) {
    const n = f(0),
      ...
      t = f(null),
      b = f([]),
      $ = q(() => e.menuList.some(o => o.children && o.children.length > 0)),
      x = f(10),
      k = f();
    K(m, o =>
      z(null, null, function* () {
        ...
        if (o) {
          ...
          let v = k.value;
          e.menuWrapperCss &&
            Object.keys(e.menuWrapperCss).map(h => {
              v.style.setProperty(
                `--menu-${h}`,
                e.menuWrapperCss && e.menuWrapperCss[h]
              );
            }),
            e.menuItemCss &&
              Object.keys(e.menuItemCss).map(h => {
                v.style.setProperty(
                  `--menu-item-${h}`,
                  e.menuItemCss && e.menuItemCss[h]
                );
              });
          let i =
            (d = (r = e.menuItemCss) == null ? void 0 : r.arrowSize) == null
              ? void 0
              : d.match(/\d+/);
          i ? (x.value = ~~i[0] || 10) : (x.value = 10),
            v.style.setProperty(
              "--menu-item-arrowRealSize",
              x.value / 2 + "px"
            ),
            a("open", e.params, t.value, e.el);
        } else a("close", e.params, t.value, e.el);
      })
    );
    const Y = (o, r) => {
        o.disabled ||
          (o.fn &&
            typeof o.fn == "function" &&
            o.fn(e.params, t.value, e.el, r) === !1) ||
          (m.value = !1);
      },
      Z = (o, r) => {
        if (!o.disabled) {
          if (o.fn && typeof o.fn == "function" && !o.disabled) {
            if (o.fn(e.params, t.value, e.el, r) === !1) return;
            u.value = !1;
          }
          m.value = !1;
        }
      ...
      ee = (o, r) =>
        z(null, null, function* () {
          if (r.children && !r.disabled) {
            (u.value = !0), yield O();
            const d = o.currentTarget;
            if (!d) return;
            const { offsetWidth: v } = d,
              i = d.querySelector(".__menu__sub__wrapper");
            if (!i) return;
            const { offsetWidth: h, offsetHeight: S } = i,
              { innerWidth: ae, innerHeight: N } = window,
              { top: R, left: H } = d.getBoundingClientRect();
            H + v + h > ae - 5 ? (n.value = H - h + 5) : (n.value = H + v),
              R + S > N - 5 ? (s.value = N - S) : (s.value = R + 5);
          }
        }),
      E = (o, r, d, v) =>
        o.map(
          i => (
            i.children && (i.children = E(i.children, r, d, v)),
            i.label &&
              typeof i.label == "function" &&
              (i.label = i.label(v, r, d)),
            i.tips && typeof i.tips == "function" && (i.tips = i.tips(v, r, d)),
            i.icon && typeof i.icon == "function" && (i.icon = i.icon(v, r, d)),
            i.hidden &&
              typeof i.hidden == "function" &&
              (i.hidden = i.hidden(v, r, d)),
            i.disabled &&
              typeof i.disabled == "function" &&
              (i.disabled = i.disabled(v, r, d)),
            i
          )
        ),
      ne = (o = 0, r = 0) =>
        z(null, null, function* () {
          if (
            ((t.value = document.elementFromPoint(o - 1, r - 1)),
            e.menuHiddenFn
              ? (m.value = !e.menuHiddenFn(e.params, t.value, e.el))
              : (m.value = !0),
            !m.value)
          )
            return;
          (b.value = X(e.menuList)),
            (b.value = E(b.value, t.value, e.el, e.params)),
            yield O();
          const { innerWidth: d, innerHeight: v } = window,
            h = k.value.offsetHeight,
            S = e.menuWidth || 200;
          (_.value = o + S + 1 > d ? d - S - 5 : o + 1),
            (y.value = r + h + 1 > v ? v - h - 5 : r + 1);
        }),
      te = () => {
        m.value = !1;
      },
      ...
      B = o => {
        k.value &&
          !k.value.contains(o.currentTarget) &&
          ((m.value = !1), (document.oncontextmenu = null));
      };
    return (
      K(
        ...
        o => {
          o
            ? document.addEventListener(T.value, B)
            : document.removeEventListener(T.value, B);
        },
        { immediate: !0 }
      ),
      de(() => {
      ...
      }),
      {
        ...
        handleSubMenuItemClick: Z,
        handleMenuMouseEnter: ee,
        show: ne,
        close: te,
        clickEventKey: T
      }
...
const be = ["onMouseenter"],
  he = { key: 0, class: "__menu__item-icon" },
  pe = ["innerHTML"],
  fe = { class: "__menu__item-label" },
  ye = { class: "__menu__item-tips" },
  ge = { class: "__menu__item-arrow-after" },
  we = { key: 0, class: "__menu__item-icon" },
  Ce = ["innerHTML"],
  ke = { class: "__menu__sub__item-label" },
  Se = { class: "__menu__sub__item-tips" };
function Me(e, a, n, s, u, y) {
  return (
    l(),
    P(
      me,
          ...
          ? (l(),
            c(
              "div",
              {
                key: 0,
                ref: "MenuWrapper",
                class: W(["__menu__wrapper", e.customClass]),
                style: A({
                      ...
                      c(
                        ...
                        [
                          !_.hidden && !_.line
                            ? (l(),
                              c(
                                ...
                                U(
                                  ...
                                  {
                                    [G(e.clickEventKey)]: J(
                                      t => e.handleMenuItemClick(_, t),
                                      ["stop"]
                                    )
                                  },
                                  {
                                    onMouseenter: t =>
                                      e.handleMenuMouseEnter(t, _)
                                  }
                                ),
                                [
                                  e.hasIcon
                                    ...
                                    : p("v-if", !0),
                                  M("span", fe, F(_.label), 1),
                                  M("span", ye, F(_.tips || ""), 1),
                                  e.hasSubMenu
                                    ? (l(),
                                      c(
                                        "span",
                                        ...
                                        [
                                          w(M("span", ge, null, 512), [
                                            [C, e.hasSubMenu && _.children]
                                          ])
                                        ],
                                        6
                                      ))
                            ...
                            : p("v-if", !0),
                          !_.hidden && _.line
                            ? (l(), c("div", { key: m, class: "__menu__line" }))
                            : p("v-if", !0)
                        ],
                        64
                      )
...
var Te = `.__menu__mask[data-v-3d21bc0a] {
  position: fixed;
  top: 0;
  left: 0;
  bottom: 0;
...
xe(Te);
g.render = Me;
g.__scopeId = "data-v-3d21bc0a";
g.__file = "packages/mouse-menu/mouse-menu.vue";
function ze(e, a, n) {
  let s = document.createElement(e);
  return s.setAttribute("class", a), s;
}
g.install = e => {
...
function Le(e) {
  var u;
  const a = "__mouse__menu__container";
  let n;
  ...
  return (
    ...
    (u = s.component) == null ? void 0 : u.proxy
  );
}
function Be() {
  const e = f(ce(ue, !0)),
    ...
    n = {
      menuList: [
        { label: ({ id: u }) => `ID为：${u}`, disabled: !0 },
        {
          ...
          fn: u =>
            ve(
              `您修改了第 ${e.value.findIndex(y => y.id === u.id) + 1} 行，数据为：${JSON.stringify(u)}`,
              { type: "success" }
            )
        }
      ]
  ...
  return { columns: a, dataList: e, showMouseMenu: s };
}
export { Be as useColumns };
