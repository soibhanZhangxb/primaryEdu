...
const M = { viewBox: "0 0 24 24", width: "1em", height: "1em" };
function C(t, e) {
  return (
    r(),
    a(
...
const _ = l({ name: "ri-group-line", render: C }),
...
const $ = l({ name: "ri-question-answer-line", render: y }),
      ...
      e[0] ||
        (e[0] = [
          o(
            ...
            {
              fill: "currentColor",
              d: "M6.455 19L2 22.5V4a1 1 0 0 1 1-1h18a1 1 0 0 1 1 1v14a1 1 0 0 1-1 1zm-.692-2H20V5H4v13.385zm5.53-4.879l4.243-4.242l1.414 1.414l-5.657 5.657l-3.89-3.89l1.415-1.414z"
            },
            null,
            -1
          )
...
const H = l({ name: "ri-chat-check-line", render: D }),
...
const N = l({ name: "ri-star-smile-line", render: B }),
  ...
  m = Array.from({ length: 30 }).map((t, e) => ({
    id: e + 1,
  ...
  Z = g(m)
    ...
    .map((t, e) =>
      Object.assign(t, {
        date: `${i().subtract(e, "day").format("YYYY-MM-DD")} ${q[i().subtract(e, "day").day()]}`
      })
    ),
  Y = { viewBox: "0 0 24 24", width: "1em", height: "1em" };
function j(t, e) {
  return (
    r(),
    a(
...
const A = l({ name: "ri-thumb-up-line", render: j }),
  O = { viewBox: "0 0 24 24", width: "1em", height: "1em" };
function R(t, e) {
  return (
    r(),
    a(
...
const S = l({ name: "ri-hearts-line", render: R }),
  T = {
...
function P() {
  const t = f([]),
    ...
    h = [
      { sortable: !0, label: "序号", prop: "id" },
      {
        ...
        filterMethod: (n, { requiredNumber: d }) =>
          n === "more" ? d >= 16e3 : d < 16e3
      },
      ...
      { sortable: !0, label: "解决数量", prop: "resolveNumber" },
      {
        ...
        prop: "satisfaction",
        cellRenderer: ({ row: n }) =>
          s("div", { class: "flex justify-center w-full" }, [
            s("span", { class: "flex items-center w-[60px]" }, [
              s("span", { class: "ml-auto mr-2" }, [n.satisfaction, x("%")]),
              s(
                L("iconifyIconOffline"),
                { icon: n.satisfaction > 98 ? S : A, color: "#e85f33" },
                null
              )
            ])
          ])
  ...
  return (
    b(() => {
      (t.value = m), (u.total = t.value.length), (e.value = !1);
    }),
    {
      Empty: I,
      loading: e,
...
const F = Object.freeze(
  Object.defineProperty(
    { __proto__: null, useColumns: P },
    Symbol.toStringTag,
    { value: "Module" }
  )
);
export { F as a, U as b, Q as c, Z as l, W as p, P as u };
