    ...
    setup(D) {
      ...
      return (w, e) => {
        const _ = n("el-link"),
          ...
          k = n("el-radio-group"),
          C = n("el-button"),
          s = n("el-collapse-item"),
          x = n("IconifyIconOnline"),
          y = n("el-collapse"),
          z = n("el-card"),
          N = O("tippy");
        return (
          ...
          p(
            ...
            { shadow: "never" },
            {
                  ...
                  },
                  {
                    default: l(
                      () =>
                        e[3] ||
                        (e[3] = [
                          t(" 代码位置 src/views/components/collapse.vue ")
                        ])
                    ),
                    _: 1,
                    __: [3]
              ...
              default: l(() => [
                e[13] || (e[13] = c("div", { class: "mb-2" }, "基础用法", -1)),
                o(
                  k,
                  {
                    modelValue: i.value,
