...
const p = { viewBox: "0 0 24 24", width: "1em", height: "1em" };
function _(o, e) {
  return (
    t(),
    n(
...
const I = i({ name: "ri-arrow-left-s-line", render: _ }),
  g = { viewBox: "0 0 24 24", width: "1em", height: "1em" };
function C(o, e) {
  return (
    t(),
    n(
...
const q = i({ name: "ri-settings-3-line", render: C }),
...
const w = i({ name: "ri-menu-fold-fill", render: x }),
  M = { viewBox: "0 0 24 24", width: "1em", height: "1em" };
function z(o, e) {
  return (
    t(),
    n(
...
const A = i({ name: "ri-menu-unfold-fill", render: z }),
  B = ["title"],
  y = u({
        ...
        return (
          ...
          n(
            "div",
            {
              ...
              title: s.isActive
                ? l(a)("buttons.pureClickCollapse")
                : l(a)("buttons.pureClickExpand"),
              onClick: d
            },
            [
              v(
...
export { w as M, q as P, y as _, I as l };
