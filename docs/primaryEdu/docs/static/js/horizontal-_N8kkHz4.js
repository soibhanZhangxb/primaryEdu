import { s as v, a as x } from "./vue-virtual-scroller.esm-BI_OJmVv.js";
import {
  d as w,
  a as d,
  p as y,
...
const b = { class: "dynamic-scroller-demo" },
        ...
        return (
          ...
          g("div", b, [
            ...
            o(
              ...
              {
                default: u(({ item: s, index: i, active: c }) => {
                  var r;
                  return [
                    o(
                      p(x),
                      {
                        item: s,
                        active: c,
                        "size-dependencies": [s.id],
                        "data-index": i,
                        "data-active": c,
                        title: `Click to change message ${i}`,
                        style: V({
                          width: `${Math.max(130, Math.round((((r = s.id) == null ? void 0 : r.length) / 20) * 20))}px`
                        }),
                        class: "message"
                      },
                      {
  ...
  O = k(S, [["__scopeId", "data-v-e266e821"]]);
export { O as default };
