...
const T = [
  ...
  W = () =>
    O.map((u, A) => {
      const Q = A % 3;
      return { avatar: T[Q].avatar, name: T[Q].name, text: u };
    });
var N = H({
  name: "vue3-danmaku",
  components: {},
  ...
  setup(u, { emit: A, slots: Q }) {
    ...
    const U = E(0),
      ...
      C = G({
        channels: h(() => u.channels || U.value),
        autoplay: h(() => u.autoplay),
        loop: h(() => u.loop),
        useSlot: h(() => u.useSlot),
        debounce: h(() => u.debounce),
        randomChannel: h(() => u.randomChannel)
      }),
      a = G({
        height: h(() => M.value),
        fontSize: h(() => u.fontSize),
        speeds: h(() => u.speeds),
        top: h(() => u.top),
        right: h(() => u.right)
      });
    function K() {
      Y(),
        u.isSuspend &&
          (function () {
            let r = [];
            s.value.addEventListener("mouseover", p => {
              let t = p.target;
              t.className.includes("dm") || (t = t.closest(".dm") || t),
                t.className.includes("dm") &&
                  (r.includes(t) ||
                    (A("dm-over", { el: t }),
                    t.classList.add("pause"),
                    r.push(t)));
            }),
              s.value.addEventListener("mouseout", p => {
                let t = p.target;
                t.className.includes("dm") || (t = t.closest(".dm") || t),
                  t.className.includes("dm") &&
                    (A("dm-out", { el: t }),
    ...
    function Y() {
      if (
        ((l.value = g.value.offsetWidth),
        (y.value = g.value.offsetHeight),
        l.value === 0 || y.value === 0)
      )
      ...
      (w.value = !1),
        c ||
          (c = window.setInterval(
            () =>
              (function () {
                if (!w.value && e.value.length)
                  if (B.value > e.value.length - 1) {
                    const r = s.value.children.length;
                    C.loop &&
                      (r < B.value && (A("list-end"), (B.value = 0)), F());
                  } else F();
              })(),
            C.debounce
          ));
    ...
    function F(r) {
      const p = C.loop ? B.value % e.value.length : B.value,
        t = r || e.value[p];
      let n = document.createElement("div");
      C.useSlot
        ? (n = (function (x, k) {
            return q({
              render: () => _("div", {}, [Q.dm && Q.dm({ danmu: x, index: k })])
            }).mount(document.createElement("div"));
          })(t, p).$el)
        : ((n.innerHTML = t),
          n.setAttribute("style", u.extraStyle),
          (n.style.fontSize = `${a.fontSize}px`),
          (n.style.lineHeight = `${a.fontSize}px`)),
        n.classList.add("dm"),
        s.value.appendChild(n),
        (n.style.opacity = "0"),
        $(() => {
          a.height || (M.value = n.offsetHeight),
            C.channels || (U.value = Math.floor(y.value / (a.height + a.top)));
          let x = (function (k) {
            let b = [...Array(C.channels).keys()];
            C.randomChannel && (b = b.sort(() => 0.5 - Math.random()));
            for (let I of b) {
              const D = d.value[I];
              if (!D || !D.length)
                return (
                  ...
                  k.addEventListener("animationend", () =>
                    d.value[I].splice(0, 1)
                  ),
                  I % C.channels
                );
              for (let V = 0; V < D.length; V++) {
                const L = X(D[V]) - 10;
                if (L <= 0.88 * (k.offsetWidth - D[V].offsetWidth) || L <= 0)
                  break;
                if (V === D.length - 1)
                  return (
                    d.value[I].push(k),
          ...
          if (x >= 0) {
            ...
            n.classList.add("move"),
              (n.dataset.index = `${p}`),
              (n.dataset.channel = x.toString()),
              (n.style.opacity = "1"),
              (n.style.top = x * (b + a.top) + "px"),
              (n.style.width = k + a.right + "px"),
              n.style.setProperty("--dm-scroll-width", `-${l.value + k}px`),
              (n.style.left = `${l.value}px`),
              (n.style.animationDuration = l.value / a.speeds + "s"),
              n.addEventListener("animationend", () => {
                Number(n.dataset.index) !== e.value.length - 1 ||
                  C.loop ||
                  A("play-end", n.dataset.index),
                  s.value && s.value.removeChild(n);
              }),
              B.value++;
          } else s.value.removeChild(n);
        });
    }
    function X(r) {
      const p = r.offsetWidth || parseInt(r.style.width),
        t =
          r.getBoundingClientRect().right ||
          s.value.getBoundingClientRect().right + p;
      return s.value.getBoundingClientRect().right - t;
    }
    function j() {
      clearInterval(c), (c = 0), (B.value = 0);
    }
    return (
      P(() => {
        K();
      ...
      }),
      {
        ...
        resize: function () {
          Y();
          const r = s.value.getElementsByClassName("dm");
          for (let p = 0; p < r.length; p++) {
            const t = r[p];
            t.style.setProperty(
              "--dm-scroll-width",
              `-${l.value + t.offsetWidth}px`
            ),
              (t.style.left = `${l.value}px`),
              (t.style.animationDuration = l.value / a.speeds + "s");
          }
        },
        play: o,
        pause: function () {
        ...
        add: function (r) {
          if (B.value === e.value.length)
            return e.value.push(r), e.value.length - 1;
          {
            const p = B.value % e.value.length;
            return e.value.splice(p, 0, r), p + 1;
          }
        },
        push: function (r) {
          return e.value.push(r), e.value.length - 1;
...
const ie = { ref: "container", class: "vue-danmaku" };
(function (u, A) {
  A === void 0 && (A = {});
  var Q = A.insertAt;
...
@-webkit-keyframes moveLeft {
      ...
      ee(
        ...
        [
          f(
            ...
            {
              ref: "dmContainer",
              class: ne(["danmus", { show: !u.hidden }, { paused: u.paused }])
            },
            null,
            2
          ),
  ...
  (N.__file = "src/lib/Danmaku.vue");
const de = { class: "card-header" },
  re = { class: "font-medium" },
  me = { class: "flex gap-5" },
  fe = { class: "danmu-item" },
  pe = ["src"],
  ve = { class: "main" },
    ...
    setup(u) {
      ...
      function c(d) {
        (l.useSlot = d),
          (Q.value = d ? W() : O),
          setTimeout(() => {
            A.value.stop(), A.value.play();
          });
      }
      function U(d) {
        (l.speeds <= 10 && d === -10) || ((l.speeds += d), A.value.reset());
      }
      function M(d) {
        (l.fontSize += d), A.value.reset();
      }
      function B(d) {
        (!l.channels && d === -1) || (l.channels += d);
      }
      function S() {
        s && clearTimeout(s),
          (s = window.setTimeout(() => {
                ...
                v(
                  ...
                  },
                  {
                    default: m(
                      () =>
                        e[18] ||
                        (e[18] = [i(" 代码位置 src/views/able/danmaku ")])
                    ),
                    _: 1,
                    __: [18]
                  }
              ...
              default: m(() => [
                f("div", me, [
                  v(
                    ...
                    se(
                      {
                        ...
                        ref: A,
                        danmus: Q.value,
                        "onUpdate:danmus": e[0] || (e[0] = o => (Q.value = o)),
                        class: "demo",
                        isSuspend: ""
                      },
                      l
                    ...
                    {
                      dm: m(({ danmu: o, index: F }) => [
                        f("div", fe, [
                          f(
                            "img",
                            { class: "img", src: o.avatar },
                            null,
                            8,
                            pe
                          ),
                          f("span", null, R(F) + R(o.name) + "：", 1),
                          f("span", null, R(o.text), 1)
                        ])
                      ]),
                      _: 1
                    },
                  ...
                  f("div", ve, [
                    f("p", null, [
                      ...
                      v(
                        a,
                        { onClick: e[1] || (e[1] = o => y("play")) },
                        {
                          default: m(() => e[19] || (e[19] = [i("播放")])),
                          _: 1,
                          __: [19]
                        }
                      ),
                      v(
                        a,
                        { onClick: e[2] || (e[2] = o => y("pause")) },
                        {
                          default: m(() => e[20] || (e[20] = [i("暂停")])),
                          _: 1,
                          __: [20]
                        }
                      ),
                      v(
                        a,
                        { onClick: e[3] || (e[3] = o => y("stop")) },
                        {
                          default: m(() => e[21] || (e[21] = [i("停止")])),
                          _: 1,
                          __: [21]
                        }
                      )
                    ...
                    f("p", null, [
                      ...
                      v(
                        a,
                        { onClick: e[4] || (e[4] = o => c(!0)) },
                        {
                          default: m(() => e[23] || (e[23] = [i("弹幕 slot")])),
                          _: 1,
                          __: [23]
                        }
                      ),
                      v(
                        a,
                        { onClick: e[5] || (e[5] = o => c(!1)) },
                        {
                          default: m(() => e[24] || (e[24] = [i("普通文本")])),
                          _: 1,
                          __: [24]
                        }
                      )
                    ...
                    f("p", null, [
                      ...
                      v(
                        a,
                        { onClick: e[6] || (e[6] = o => y("show")) },
                        {
                          default: m(() => e[26] || (e[26] = [i("显示")])),
                          _: 1,
                          __: [26]
                        }
                      ),
                      v(
                        a,
                        { onClick: e[7] || (e[7] = o => y("hide")) },
                        {
                          default: m(() => e[27] || (e[27] = [i("隐藏")])),
                          _: 1,
                          __: [27]
                        }
                      )
                    ...
                    f("p", null, [
                      ...
                      v(
                        a,
                        { onClick: e[8] || (e[8] = o => U(-10)) },
                        {
                          default: m(() => e[29] || (e[29] = [i("减速")])),
                          _: 1,
                          __: [29]
                        }
                      ),
                      v(
                        a,
                        { onClick: e[9] || (e[9] = o => U(10)) },
                        {
                          default: m(() => e[30] || (e[30] = [i("增速")])),
                          _: 1,
                          __: [30]
                        }
                      ),
                      f("span", ge, "当前速度：" + R(l.speeds) + "像素/s", 1)
                    ]),
                    f("p", null, [
                      e[34] || (e[34] = i(" 字号： ")),
                      v(
                        ...
                        {
                          disabled: l.useSlot,
                          onClick: e[10] || (e[10] = o => M(-1))
                        },
                        {
                          default: m(() => e[32] || (e[32] = [i(" 缩小 ")])),
                          _: 1,
                          __: [32]
                        },
                        8,
                      ...
                      v(
                        ...
                        {
                          disabled: l.useSlot,
                          onClick: e[11] || (e[11] = o => M(1))
                        },
                        {
                          default: m(() => e[33] || (e[33] = [i(" 放大 ")])),
                          _: 1,
                          __: [33]
                        },
                        8,
                      ...
                      f("span", Ce, "当前字号：" + R(l.fontSize) + "px", 1)
                    ]),
                    f("p", null, [
                      e[38] || (e[38] = i(" 轨道： ")),
                      v(
                        a,
                        { onClick: e[12] || (e[12] = o => B(-1)) },
                        {
                          default: m(() => e[35] || (e[35] = [i("-1")])),
                          _: 1,
                          __: [35]
                        }
                      ),
                      v(
                        a,
                        { onClick: e[13] || (e[13] = o => B(1)) },
                        {
                          default: m(() => e[36] || (e[36] = [i("+1")])),
                          _: 1,
                          __: [36]
                        }
                      ),
                      v(
                        a,
                        { onClick: e[14] || (e[14] = o => B(-l.channels)) },
                        {
                          default: m(() => e[37] || (e[37] = [i(" 填满 ")])),
                          _: 1,
                          __: [37]
                        }
                      ),
                      f("span", Be, "当前轨道：" + R(l.channels), 1)
                    ]),
                    f("p", Ee, [
                      v(
                        K,
  ...
  ke = ue(Qe, [["__scopeId", "data-v-d4dc730e"]]);
