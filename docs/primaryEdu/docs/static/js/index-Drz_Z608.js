...
var R = (a, s, t) =>
    s in a
      ? A(a, s, { enumerable: !0, configurable: !0, writable: !0, value: t })
      : (a[s] = t),
  k = (a, s) => {
    for (var t in s || (s = {})) C.call(s, t) && R(a, t, s[t]);
    if (z) for (var t of z(s)) X.call(s, t) && R(a, t, s[t]);
    return a;
  };
  ...
  Z = L({
    ...
    setup(a, { emit: s }) {
      const t = r(0),
        ...
        m = r(""),
        f = T(),
        d = o(a.modelValue) ? q(a, "modelValue") : r(0);
      function D({ option: e, index: l }, u) {
        a.disabled ||
          e.disabled ||
          (u.preventDefault(),
          o(a.modelValue) ? s("update:modelValue", l) : (d.value = l),
          (m.value = ""),
      ...
      function S({ option: e, index: l }, u) {
        a.disabled ||
          ...
          e.disabled || d.value === l
            ? (m.value = "")
            : (m.value = b.value ? "#1f1f1f" : "rgba(0, 0, 0, 0.06)"));
      }
      function $(e, l) {
        ...
        a.options.map((e, l) =>
          n(
            "label",
            {
              ...
              onMouseenter: u => S({ option: e, index: l }, u),
              onMouseleave: u => $({}, u),
              onClick: u => D({ option: e, index: l }, u)
            },
            [
                ...
                n("div", { class: "pure-segmented-item-label" }, [
                  e.icon && !M(e.label)
                    ? n(
                        ...
                        [I(B(e.icon, k({}, e == null ? void 0 : e.iconAttrs)))]
                      )
                    : null,
                  e.label
                    ? M(e.label)
