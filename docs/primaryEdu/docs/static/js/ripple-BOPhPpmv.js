...
const y = {
  ...
  g = { class: "inline-block shadow-md rounded-md p-8 text-lg select-none" },
  x = {
    class: "mb-5 text-center shadow-md rounded-md p-8 text-lg select-none"
  },
  k = {
        ...
        return (
          ...
          r(
            ...
            { shadow: "never" },
            {
              header: n(() => [
                e[1] ||
                  (e[1] = i("p", { class: "font-medium" }, "波纹(Ripple)", -1)),
                a(
                  v,
                  {
                    class: "mt-2",
                  ...
                  },
                  {
                    default: n(
                      () =>
                        e[0] ||
                        (e[0] = [s(" 代码位置 src/views/able/ripple.vue ")])
                    ),
                    _: 1,
                    __: [0]
                  }
              ...
              default: n(() => [
                e[13] ||
                  (e[13] = i("div", { class: "mb-5" }, "组件中的波纹", -1)),
                a(u, {
                  title:
                ...
                o(
                  ...
                  r(
                    _,
                    { class: "mb-5 w-[510px] select-none", shadow: "hover" },
                    {
                      default: n(() => e[8] || (e[8] = [s(" 卡片 ")])),
                      _: 1,
                      __: [8]
                    }
                  )),
                ...
                o(
                  (t(),
                  m("div", x, e[11] || (e[11] = [s(" 始终从中心触发波纹 ")]))),
                  [[l, void 0, void 0, { center: !0 }]]
                ),
                e[16] ||
                  (e[16] = i(
                    "div",
