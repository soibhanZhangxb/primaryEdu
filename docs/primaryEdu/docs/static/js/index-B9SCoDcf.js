...
var jt = (a, t, i) =>
    t in a
      ? Se(a, t, { enumerable: !0, configurable: !0, writable: !0, value: i })
      : (a[t] = i),
  ht = (a, t) => {
    for (var i in t || (t = {})) _e.call(t, i) && jt(a, i, t[i]);
    if (Ut) for (var i of Ut(t)) Be.call(t, i) && jt(a, i, t[i]);
    return a;
  },
  Gt = (a, t) => Ae(a, Le(t));
var qt = (a, t, i) =>
...
function Kt(a, t) {
  for (var i = 0; i < t.length; i++) {
    ...
    (e.enumerable = e.enumerable || !1),
      ...
      Object.defineProperty(a, pe(e.key), e);
  }
}
function Je(a, t, i) {
  return (
...
function fe(a) {
  return ei(a) || ii(a) || ai(a) || ri();
}
function ei(a) {
  if (Array.isArray(a)) return Ot(a);
}
function ii(a) {
  if (
...
function ai(a, t) {
  if (a) {
    if (typeof a == "string") return Ot(a, t);
...
var xt = typeof window != "undefined" && typeof window.document != "undefined",
  q = xt ? window : {},
  kt =
    xt && q.document.documentElement
      ? "ontouchstart" in q.document.documentElement
      : !1,
  Ht = xt ? "PointerEvent" in q : !1,
  T = "cropper",
  zt = "all",
  ge = "crop",
  ve = "move",
  ...
  dt = "sw",
  Rt = "".concat(T, "-crop"),
  Zt = "".concat(T, "-disabled"),
  Y = "".concat(T, "-hidden"),
  Jt = "".concat(T, "-hide"),
  ni = "".concat(T, "-invisible"),
  yt = "".concat(T, "-modal"),
  Nt = "".concat(T, "-move"),
  ft = "".concat(T, "Action"),
  wt = "".concat(T, "Preview"),
  ...
  _t = "cropstart",
  te = "dblclick",
  oi = kt ? "touchstart" : "mousedown",
  si = kt ? "touchmove" : "mousemove",
  hi = kt ? "touchend touchcancel" : "mouseup",
  ee = Ht ? "pointerdown" : oi,
  ie = Ht ? "pointermove" : si,
  ae = Ht ? "pointerup pointercancel" : hi,
  re = "ready",
  ne = "resize",
  oe = "wheel",
  Bt = "zoom",
  se = "image/jpeg",
  ci = /^e|w|s|n|se|sw|ne|nw|all|crop|move|zoom$/,
  li = /^data:/,
  ui = /^data:image\/jpeg;base64,/,
  di = /^img|canvas$/i,
  ye = 200,
  xe = 100,
  he = {
  ...
  fi = Number.isNaN || q.isNaN;
function m(a) {
  return typeof a == "number" && !fi(a);
}
var ce = function (t) {
  return t > 0 && t < 1 / 0;
};
...
function rt(a) {
  ...
  try {
    var t = a.constructor,
      i = t.prototype;
    return t && i && gi.call(i, "isPrototypeOf");
  } catch (e) {
    return !1;
  }
}
...
var vi = Array.prototype.slice;
function De(a) {
  return Array.from ? Array.from(a) : vi.call(a);
}
function L(a, t) {
  return (
    a &&
...
function ot(a) {
  ...
  return mi.test(a) ? Math.round(a * t) / t : a;
}
var wi = /^width|height|left|top|marginLeft|marginTop$/;
function K(a, t) {
  var i = a.style;
  L(t, function (e, o) {
    wi.test(o) && m(e) && (e = "".concat(e, "px")), (i[o] = e);
  });
}
function bi(a, t) {
...
function It(a, t) {
  return it(a[t])
    ...
    : a.dataset
      ? a.dataset[t]
      : a.getAttribute("data-".concat(Xt(t)));
}
function gt(a, t, i) {
  it(i)
    ? (a[t] = i)
    : a.dataset
      ? (a.dataset[t] = i)
      : a.setAttribute("data-".concat(Xt(t)), i);
}
function xi(a, t) {
  if (it(a[t]))
    try {
  ...
  else a.removeAttribute("data-".concat(Xt(t)));
}
var Me = /\s\s*/,
  Ce = (function () {
    var a = !1;
    if (xt) {
      ...
      q.addEventListener("test", i, e), q.removeEventListener("test", i, e);
    }
    return a;
  })();
function j(a, t, i) {
...
function le(a) {
  ...
  return (
    t !== null &&
    (t[1] !== Et.protocol || t[2] !== Et.hostname || t[3] !== Et.port)
  );
}
function ue(a) {
...
function pt(a) {
  var t = a.rotate,
    ...
    r = a.translateY,
    n = [];
  m(o) && o !== 0 && n.push("translateX(".concat(o, "px)")),
    m(r) && r !== 0 && n.push("translateY(".concat(r, "px)")),
    m(t) && t !== 0 && n.push("rotate(".concat(t, "deg)")),
    m(i) && i !== 1 && n.push("scaleX(".concat(i, ")")),
    m(e) && e !== 1 && n.push("scaleY(".concat(e, ")"));
...
function bt(a, t) {
  var i = a.pageX,
    e = a.pageY,
    o = { endX: i, endY: e };
  return t ? o : de({ startX: i, startY: e }, o);
}
function Ci(a) {
  var t = 0,
    i = 0,
...
function Ti(a, t, i, e) {
  var o = t.aspectRatio,
    ...
    D = i.naturalHeight,
    f = e.fillColor,
    R = f === void 0 ? "transparent" : f,
    N = e.imageSmoothingEnabled,
    E = N === void 0 ? !0 : N,
    ...
    I = M.getContext("2d"),
    J = Z({ aspectRatio: g, width: b, height: P }),
    vt = Z({ aspectRatio: g, width: y, height: C }, "cover"),
    Dt = Math.min(J.width, Math.max(vt.width, v)),
    Mt = Math.min(J.height, Math.max(vt.height, D)),
    Yt = Z({ aspectRatio: o, width: b, height: P }),
    Wt = Z({ aspectRatio: o, width: y, height: C }, "cover"),
    Vt = Math.min(Yt.width, Math.max(Wt.width, r)),
    $t = Math.min(Yt.height, Math.max(Wt.height, n)),
    Re = [-Vt / 2, -$t / 2, Vt, $t];
  return (
    (M.width = ot(Dt)),
    (M.height = ot(Mt)),
    (I.fillStyle = R),
    I.fillRect(0, 0, Dt, Mt),
    I.save(),
    I.translate(Dt / 2, Mt / 2),
    I.rotate((u * Math.PI) / 180),
    I.scale(h, d),
    (I.imageSmoothingEnabled = E),
    (I.imageSmoothingQuality = k),
    I.drawImage.apply(
      I,
      [a].concat(
        fe(
          Re.map(function (Ne) {
            return Math.floor(ot(Ne));
          })
        )
      )
    ),
...
function Oi(a, t, i) {
  var e = "";
  i += t;
  for (var o = t; o < i; o += 1) e += Te(a.getUint8(o));
  return e;
}
var Ri = /^data:.*,/;
function Ni(a) {
...
function Si(a, t) {
  for (var i = [], e = 8192, o = new Uint8Array(a); o.length > 0; )
    i.push(Te.apply(null, De(o.subarray(0, e)))), (o = o.subarray(e));
  ...
  try {
    ...
    if (r) {
      var d = t.getUint16(r, e),
        ...
        v;
      for (v = 0; v < d; v += 1)
        if (((g = r + v * 12 + 2), t.getUint16(g, e) === 274)) {
...
var _i = {
    ...
    initContainer: function () {
      ...
      B(o, Y), G(t, Y);
      var s = {
        width: Math.max(e.offsetWidth, r >= 0 ? r : ye),
        height: Math.max(e.offsetHeight, n >= 0 ? n : xe)
      };
      (this.containerData = s),
        K(o, { width: s.width, height: s.height }),
        B(t, Y),
        G(o, Y);
    },
    initCanvas: function () {
    ...
    limitCanvas: function (t, i) {
            ...
            (h
              ...
              : c
                ...
                : l &&
                  ...
                  (c = n.height),
                  c * u > h ? (h = c * u) : (c = h / u)));
        var d = Z({ aspectRatio: u, width: h, height: c });
        (h = d.width),
          (c = d.height),
          (r.minWidth = h),
          (r.minHeight = c),
      ...
      if (i)
        if (s > (l ? 0 : 1)) {
          var g = o.width - r.width,
            v = o.height - r.height;
          (r.minLeft = Math.min(0, g)),
            (r.minTop = Math.min(0, v)),
            (r.maxLeft = Math.max(0, g)),
            (r.maxTop = Math.max(0, v)),
            l &&
              this.limited &&
              ...
              s === 2 &&
                ...
                r.height >= o.height &&
                  ((r.minTop = Math.min(0, v)), (r.maxTop = Math.max(0, v)))));
        } else
          (r.minLeft = -r.width),
            (r.minTop = -r.height),
            (r.maxLeft = o.width),
      ...
      (e.width > e.maxWidth || e.width < e.minWidth) && (e.left = e.oldLeft),
        ...
        K(
          ...
          O(
            ...
            pt({ translateX: e.left, translateY: e.top })
          )
        ),
        this.renderImage(t),
    ...
    renderImage: function (t) {
      ...
      O(e, {
        ...
        K(
          ...
          O(
            { width: e.width, height: e.height },
            pt(O({ translateX: e.left, translateY: e.top }, e))
          )
        ),
        t && this.output();
    },
      ...
      (e.width > e.maxWidth || e.width < e.minWidth) && (e.left = e.oldLeft),
        ...
        t.movable &&
          ...
          gt(
            this.face,
            ft,
            e.width >= i.width && e.height >= i.height ? ve : zt
          ),
        K(
          this.cropBox,
          O(
    ...
    output: function () {
      this.preview(), st(this.element, St, this.getData());
    }
  },
  Bi = {
    ...
    resetPreview: function () {
      L(this.previews, function (t) {
        var i = It(t, wt);
        K(t, { width: i.width, height: i.height }),
          (t.innerHTML = i.html),
          xi(t, wt);
      });
    },
    preview: function () {
      ...
      !this.cropped ||
        ...
        (K(
          ...
          O(
            { width: n, height: s },
            pt(O({ translateX: -u, translateY: -l }, t))
          )
        ),
        L(this.previews, function (h) {
          var c = It(h, wt),
            d = c.width,
            g = c.height,
            v = d,
            ...
            f = 1;
          o && ((f = d / o), (D = r * f)),
            r && D > g && ((f = g / r), (v = o * f), (D = g)),
            K(h, { width: v, height: D }),
            K(
              h.getElementsByTagName("img")[0],
              O(
                { width: n * f, height: s * f },
                pt(O({ translateX: -u * f, translateY: -l * f }, t))
              )
            );
        }));
    }
  ...
  Ii = {
    bind: function () {
      var t = this.element,
        i = this.options,
        e = this.cropper;
      X(i.cropstart) && U(t, _t, i.cropstart),
        X(i.cropmove) && U(t, Lt, i.cropmove),
        X(i.cropend) && U(t, At, i.cropend),
        X(i.crop) && U(t, St, i.crop),
        X(i.zoom) && U(t, Bt, i.zoom),
        U(e, ee, (this.onCropStart = this.cropStart.bind(this))),
        i.zoomable &&
          i.zoomOnWheel &&
          U(e, oe, (this.onWheel = this.wheel.bind(this)), {
            passive: !1,
            capture: !0
          }),
        i.toggleDragModeOnDblclick &&
          U(e, te, (this.onDblclick = this.dblclick.bind(this))),
        U(t.ownerDocument, ie, (this.onCropMove = this.cropMove.bind(this))),
        U(t.ownerDocument, ae, (this.onCropEnd = this.cropEnd.bind(this))),
        i.responsive && U(window, ne, (this.onResize = this.resize.bind(this)));
    },
    unbind: function () {
      var t = this.element,
        i = this.options,
        e = this.cropper;
      X(i.cropstart) && j(t, _t, i.cropstart),
        X(i.cropmove) && j(t, Lt, i.cropmove),
        X(i.cropend) && j(t, At, i.cropend),
        X(i.crop) && j(t, St, i.crop),
        X(i.zoom) && j(t, Bt, i.zoom),
        j(e, ee, this.onCropStart),
        i.zoomable &&
          i.zoomOnWheel &&
          j(e, oe, this.onWheel, { passive: !1, capture: !0 }),
        i.toggleDragModeOnDblclick && j(e, te, this.onDblclick),
        j(t.ownerDocument, ie, this.onCropMove),
        j(t.ownerDocument, ae, this.onCropEnd),
        i.responsive && j(window, ne, this.onResize);
    }
  },
  ki = {
    resize: function () {
      if (!this.disabled) {
        ...
        if (n !== 1) {
          var s, u;
          t.restore &&
            ((s = this.getCanvasData()), (u = this.getCropBoxData())),
            this.render(),
            t.restore &&
              (this.setCanvasData(
                L(s, function (l, h) {
    ...
    dblclick: function () {
      this.disabled ||
        this.options.dragMode === be ||
        this.setDragMode(bi(this.dragBox, Rt) ? we : Pt);
    },
    wheel: function (t) {
      var i = this,
    ...
    cropStart: function (t) {
      ...
      if (
        ...
        var o = this.options,
          ...
          n;
        t.changedTouches
          ? L(t.changedTouches, function (s) {
              r[s.identifier] = bt(s);
            })
          : (r[t.pointerId || 0] = bt(t)),
          Object.keys(r).length > 1 && o.zoomable && o.zoomOnTouch
            ? (n = me)
            : (n = It(t.target, ft)),
          ci.test(n) &&
            st(this.element, _t, { originalEvent: t, action: n }) !== !1 &&
            (t.preventDefault(),
            (this.action = n),
            (this.cropping = !1),
            n === ge && ((this.cropping = !0), B(this.dragBox, yt)));
      }
    },
    cropMove: function (t) {
      var i = this.action;
      if (!(this.disabled || !i)) {
        var e = this.pointers;
        t.preventDefault(),
          st(this.element, Lt, { originalEvent: t, action: i }) !== !1 &&
            (t.changedTouches
              ? L(t.changedTouches, function (o) {
                  O(e[o.identifier] || {}, bt(o, !0));
                })
              : O(e[t.pointerId || 0] || {}, bt(t, !0)),
            this.change(t));
      }
    },
    cropEnd: function (t) {
      if (!this.disabled) {
        ...
        t.changedTouches
          ...
          i &&
            ...
            this.cropping &&
              ((this.cropping = !1),
              nt(this.dragBox, yt, this.cropped && this.options.modal)),
            st(this.element, At, { originalEvent: t, action: i }));
      }
    }
  },
  Hi = {
    change: function (t) {
      ...
      !u && t.shiftKey && (u = c && d ? c / d : 1),
        this.limited &&
          ((D = r.minLeft),
          (f = r.minTop),
          (R = D + Math.min(o.width, e.width, e.left + e.width)),
          (N = f + Math.min(o.height, e.height, e.top + e.height)));
      var k = n[Object.keys(n)[0]],
        p = { x: k.endX - k.startX, y: k.endY - k.startY },
        b = function (P) {
          switch (P) {
            case tt:
              g + p.x > R && (p.x = R - g);
      ...
      switch (s) {
        ...
        case lt:
          if (u) {
            ...
            b(Q), (d -= p.y), (h += p.y), (c = d * u), (l += r.width - c);
          } else
            b(Q),
              b(et),
              p.x <= 0
            ...
            b(at),
              ...
              p.x <= 0
                ? l > D
                  ...
                  : p.y >= 0 && v >= N && (E = !1)
                : ((c -= p.x), (l += p.x)),
              p.y >= 0 ? v < N && (d += p.y) : (d += p.y);
          c < 0 && d < 0
            ? ((s = ct), (d = -d), (c = -c), (h -= d), (l -= c))
            : c < 0
              ? ((s = ut), (c = -c), (l -= c))
              : d < 0 && ((s = lt), (d = -d), (h -= d));
          break;
        case ut:
          if (u) {
            ...
            b(at),
              ...
              p.y >= 0 ? v < N && (d += p.y) : (d += p.y);
          c < 0 && d < 0
            ? ((s = lt), (d = -d), (c = -c), (h -= d), (l -= c))
            : c < 0
              ? ((s = dt), (c = -c), (l -= c))
              : d < 0 && ((s = ct), (d = -d), (h -= d));
          break;
        case ve:
          this.move(p.x, p.y), (E = !1);
          break;
        case me:
          this.zoom(Mi(n), t), (E = !1);
          break;
        case ge:
          if (!p.x || !p.y) {
            E = !1;
  ...
  zi = {
    crop: function () {
      return (
        this.ready &&
          ...
          ((this.cropped = !0),
          this.limitCropBox(!0, !0),
          this.options.modal && B(this.dragBox, yt),
          G(this.cropBox, Y),
    ...
    reset: function () {
      return (
        this.ready &&
          ...
          (this.canvasData = O({}, this.initialCanvasData)),
          (this.cropBoxData = O({}, this.initialCropBoxData)),
          this.renderCanvas(),
          this.cropped && this.renderCropBox()),
        this
      );
    ...
    clear: function () {
      return (
        this.cropped &&
          !this.disabled &&
          (O(this.cropBoxData, { left: 0, top: 0, width: 0, height: 0 }),
          (this.cropped = !1),
          this.renderCropBox(),
          this.limitCanvas(!0, !0),
          this.renderCanvas(),
    ...
    enable: function () {
      return (
        this.ready &&
          this.disabled &&
          ((this.disabled = !1), G(this.cropper, Zt)),
        this
      );
    },
    disable: function () {
      return (
        this.ready &&
          !this.disabled &&
          ((this.disabled = !0), B(this.cropper, Zt)),
        this
      );
    },
    destroy: function () {
    ...
    move: function (t) {
      var i =
        ...
        o = e.left,
        r = e.top;
      return this.moveTo(Ct(t) ? t : o + Number(t), Ct(i) ? i : r + Number(i));
    },
    moveTo: function (t) {
      var i =
          arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : t,
    ...
    zoomTo: function (t, i, e) {
      ...
      if (
        ...
        if (e) {
          ...
          (r.left -= (h - n) * ((v.pageX - g.left - r.left) / n)),
            (r.top -= (c - s) * ((v.pageY - g.top - r.top) / s));
        } else
          rt(i) && m(i.x) && m(i.y)
    ...
    scaleX: function (t) {
      ...
      return this.scale(t, m(i) ? i : 1);
    },
    scaleY: function (t) {
      var i = this.imageData.scaleX;
      return this.scale(m(i) ? i : 1, t);
    },
    scale: function (t) {
      var i =
          arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : t,
    ...
    setData: function (t) {
      ...
      if (this.ready && !this.disabled && rt(t)) {
        ...
        var s = e.width / e.naturalWidth;
        m(t.x) && (r.left = t.x * s + o.left),
          m(t.y) && (r.top = t.y * s + o.top),
          m(t.width) && (r.width = t.width * s),
          m(t.height) && (r.height = t.height * s),
    ...
    setCanvasData: function (t) {
      ...
      return (
        this.ready &&
          !this.disabled &&
          rt(t) &&
          (m(t.left) && (i.left = t.left),
          m(t.top) && (i.top = t.top),
          m(t.width)
            ? ((i.width = t.width), (i.height = t.width / e))
            : m(t.height) && ((i.height = t.height), (i.width = t.height * e)),
          this.renderCanvas(!0)),
        this
      );
    },
    ...
    setCropBoxData: function (t) {
      ...
      return (
        this.ready &&
          ...
          (m(t.left) && (i.left = t.left),
          m(t.top) && (i.top = t.top),
          m(t.width) && t.width !== i.width && ((o = !0), (i.width = t.width)),
          m(t.height) &&
            t.height !== i.height &&
    ...
    getCroppedCanvas: function () {
      ...
      var i = this.canvasData,
        e = Ti(this.image, this.imageData, i, t);
      ...
      var h = s / u,
        ...
        v = g.width,
        D = g.height;
      (v = Math.min(c.width, Math.max(d.width, v))),
        (D = Math.min(c.height, Math.max(d.height, D)));
      var f = document.createElement("canvas"),
        R = f.getContext("2d");
      (f.width = ot(v)),
        (f.height = ot(D)),
        (R.fillStyle = t.fillColor || "transparent"),
        R.fillRect(0, 0, v, D);
      var N = t.imageSmoothingEnabled,
        E = N === void 0 ? !0 : N,
        $ = t.imageSmoothingQuality;
      (R.imageSmoothingEnabled = E), $ && (R.imageSmoothingQuality = $);
      var k = e.width,
        p = e.height,
        b = r,
        S = n,
      ...
      b <= -s || b > k
        ? ((b = 0), (P = 0), (y = 0), (C = 0))
        : b <= 0
          ? ((y = -b), (b = 0), (P = Math.min(k, s + b)), (C = P))
          : b <= k && ((y = 0), (P = Math.min(s, k - b)), (C = P)),
        P <= 0 || S <= -u || S > p
          ? ((S = 0), (w = 0), (x = 0), (M = 0))
          : S <= 0
            ? ((x = -S), (S = 0), (w = Math.min(p, u + S)), (M = w))
            : S <= p && ((x = 0), (w = Math.min(u, p - S)), (M = w));
      var I = [b, S, P, w];
      if (C > 0 && M > 0) {
        var J = v / s;
        I.push(y * J, x * J, C * J, M * J);
      }
      return (
        R.drawImage.apply(
          R,
    ...
    setDragMode: function (t) {
      ...
      if (this.ready && !this.disabled) {
        ...
        (t = r || n ? t : be),
          ...
          nt(e, Rt, r),
          nt(e, Nt, n),
          i.cropBoxMovable || (gt(o, ft, t), nt(o, Rt, r), nt(o, Nt, n));
      }
      return this;
    }
  },
        ...
        },
        {
          ...
          value: function (i) {
            ...
            if (i) {
              ...
              if (li.test(i)) {
                ui.test(i) ? this.read(Ni(i)) : this.clone();
                return;
              }
              ...
              (this.reloading = !0),
                ...
                (n.onprogress = function () {
                  n.getResponseHeader("content-type") !== se && n.abort();
                }),
                (n.onload = function () {
                  e.read(n.response);
                }),
                ...
                r.checkCrossOrigin && le(i) && o.crossOrigin && (i = ue(i)),
                n.open("GET", i, !0),
            ...
            var o =
              ...
              r = function (l, h) {
                O(i.imageData, {
                  ...
                  (i.initialImageData = O({}, i.imageData)),
                  (i.sizing = !1),
                  (i.sized = !0),
                  i.build();
              };
        ...
        },
        {
          ...
          value: function () {
            if (!(!this.sized || this.ready)) {
              ...
              n.innerHTML = pi;
              var s = n.querySelector(".".concat(T, "-container")),
                u = s.querySelector(".".concat(T, "-canvas")),
                l = s.querySelector(".".concat(T, "-drag-box")),
                h = s.querySelector(".".concat(T, "-crop-box")),
                c = h.querySelector(".".concat(T, "-face"));
              (this.container = r),
                (this.cropper = s),
                (this.canvas = u),
                (this.dragBox = l),
                (this.cropBox = h),
                (this.viewBox = s.querySelector(".".concat(T, "-view-box"))),
                (this.face = c),
                u.appendChild(o),
                B(i, Y),
                ...
                B(h, Y),
                e.guides ||
                  B(h.getElementsByClassName("".concat(T, "-dashed")), Y),
                e.center ||
                  B(h.getElementsByClassName("".concat(T, "-center")), Y),
                e.background && B(s, "".concat(T, "-bg")),
                e.highlight || B(c, ni),
                e.cropBoxMovable && (B(c, Nt), gt(c, ft, zt)),
                e.cropBoxResizable ||
                  (B(h.getElementsByClassName("".concat(T, "-line")), Y),
                  B(h.getElementsByClassName("".concat(T, "-point")), Y)),
                this.render(),
                (this.ready = !0),
                this.setDragMode(e.dragMode),
                e.autoCrop && this.crop(),
                this.setData(e.data),
                X(e.ready) && U(i, re, e.ready, { once: !0 }),
                st(i, re);
            }
          }
        },
        {
          ...
          value: function () {
            if (this.ready) {
              ...
              i && i.removeChild(this.cropper), G(this.element, Y);
            }
          }
        },
        {
...
O(Oe.prototype, _i, Bi, Ii, ki, Hi, zi);
const Xi = {
  ...
  Sa = Ft({
    ...
    setup(a, { attrs: t, emit: i }) {
      ...
      let c = 1,
        d = 1;
      const g = Xe(E, 80),
        v = mt(() => ht({ height: a.height, maxWidth: "100%" }, a.imageStyle)),
        D = mt(() => [t.class, { "re-circled": n.value }]),
        f = mt(() => [
          "p-[6px]",
          "h-[30px]",
          "w-[30px]",
        ...
        R = mt(() => ({ height: `${a.height}`.replace(/px/, "") + "px" }));
      ke(N),
        He(() => {
          var w;
          (w = r.value) == null || w.destroy(),
            (l.value = !1),
            (r.value = null),
            (h.value = ""),
            (c = 1),
      ...
      function $() {
        if (!r.value) return;
        (n.value ? k() : r.value.getCroppedCanvas()).toBlob(y => {
          if (!y) return;
          const x = new FileReader();
          x.readAsDataURL(y),
            (x.onloadend = C => {
              var M;
              !((M = C.target) != null && M.result) ||
                !y ||
                ((h.value = C.target.result),
                i("cropper", {
                  base64: C.target.result,
                  blob: y,
                  info: ht({ size: y.size }, r.value.getData())
                }));
            }),
            (x.onerror = () => {
              i("error");
      ...
      function k() {
        const w = r.value.getCroppedCanvas(),
        ...
        return (
          ...
          x.drawImage(w, 0, 0, C, M),
          (x.globalCompositeOperation = "destination-in"),
          x.beginPath(),
          x.arc(C / 2, M / 2, Math.min(C, M) / 2, 0, 2 * Math.PI, !0),
          x.fill(),
          y
        );
      }
      function p(w, y) {
        var x, C, M, I;
        w === "scaleX" && (c = y = c === -1 ? 1 : -1),
          w === "scaleY" && (d = y = d === -1 ? 1 : -1),
          y && qe(y)
            ? (C = (x = r.value) == null ? void 0 : x[w]) == null ||
              C.call(x, ...y)
            : (I = (M = r.value) == null ? void 0 : M[w]) == null ||
              I.call(M, y);
      }
      function b(w) {
        ...
        return (
          ...
          (y.onload = x => {
            var C;
            u.value = (C = x.target) == null ? void 0 : C.result;
          }),
          (y.onloadend = () => {
            N();
          }),
      ...
      const S = Ft({
        directives: { tippy: Ue, longpress: $e },
        setup() {
          return () =>
            _("div", { class: "flex flex-wrap w-[60px] justify-between" }, [
              _(
                je,
                { accept: "image/*", "show-file-list": !1, "before-upload": b },
                {
                  default: () => [
                    H(_(Ui, { class: f.value }, null), [
                      [A("tippy"), { content: "上传", placement: "left-start" }]
                    ])
                  ]
                }
              ),
              H(
                _(
                  ...
                  {
                    class: f.value,
                    onClick: () => Ge(h.value, "cropping.png")
                  },
                  null
                ),
                [[A("tippy"), { content: "下载", placement: "right-start" }]]
              ),
              H(
                _(
                  aa,
              ...
              H(_(Wi, { class: f.value, onClick: () => p("reset") }, null), [
                [A("tippy"), { content: "重置", placement: "right-start" }]
              ]),
              H(_(ta, { class: f.value }, null), [
                [
                  A("tippy"),
                  { content: "上移（可长按）", placement: "left-start" }
                ],
                [A("longpress"), () => p("move", [0, -10]), "0:100"]
              ]),
              H(_(oa, { class: f.value }, null), [
                [
                  A("tippy"),
              ...
              H(_(ca, { class: f.value }, null), [
                [
                  A("tippy"),
                  { content: "左移（可长按）", placement: "left-start" }
                ],
                [A("longpress"), () => p("move", [-10, 0]), "0:100"]
              ]),
              H(_(ga, { class: f.value }, null), [
                [
                  A("tippy"),
              ...
              H(
                _(qi, { class: f.value, onClick: () => p("scaleX", -1) }, null),
                [[A("tippy"), { content: "水平翻转", placement: "left-start" }]]
              ),
              H(
                _(Ki, { class: f.value, onClick: () => p("scaleY", -1) }, null),
                [
                  [
                    A("tippy"),
              ...
              H(
                _(
                  wa,
                  { class: f.value, onClick: () => p("rotate", -45) },
                  null
                ),
                [
                  [
              ...
              H(
                _(Ca, { class: f.value, onClick: () => p("rotate", 45) }, null),
                [
                  [
                    A("tippy"),
              ...
              H(_(xa, { class: f.value }, null), [
                [
                  A("tippy"),
                  { content: "放大（可长按）", placement: "left-start" }
                ],
                [A("longpress"), () => p("zoom", 0.1), "0:100"]
              ]),
              H(_(Oa, { class: f.value }, null), [
                [
                  A("tippy"),
      ...
      function P(w) {
        ...
        if (
          ...
          if (!M.value.isShown && !M.value.isVisible) return;
          Ve(e, "click", C);
        }
      }
      return {
    ...
    render() {
      const {
        ...
        { alt: n, crossorigin: s } = this.props;
      return a
        ? _(
            "div",
            { ref: "tippyElRef", class: i, style: r, onContextmenu: u => o(u) },
            [
              H(
                _(
                  "img",
                  { ref: "imgElRef", style: e, src: a, alt: n, crossorigin: s },
                  null
                ),
                [[Fe, t]]
              )
