...
var G = (e, t, i) =>
    t in e
      ...
      : (e[t] = i),
  C = (e, t) => {
    for (var i in t || (t = {})) ve.call(t, i) && G(e, i, t[i]);
    if (X) for (var i of X(t)) ye.call(t, i) && G(e, i, t[i]);
    return e;
  },
  E = (e, t) => me(e, pe(t));
import {
...
const Me = ze();
be("data-v-b329ee4c");
const Pe = { class: "resize-observer", tabindex: "-1" };
ge();
const Ue = Me((e, t, i, s, r, a) => (_(), U("div", Pe)));
H.render = Ue;
    ...
    l = function (n) {
      ...
      if (((a = p), !(s && n === r))) {
        ...
        typeof I == "function" && (I = I(n, r)),
          (!s || n !== r) && I && e.apply(void 0, [n].concat(ee(a))),
          (r = n),
          clearTimeout(s),
...
function ne(e, t) {
  if (e === t) return !0;
  if (P(e) === "object") {
    for (var i in e) if (!ne(e[i], t[i])) return !1;
    return !0;
  }
  return !1;
}
...
function Ke(e, t, i) {
  ...
  if (!ne(s, r)) {
    ...
    a ? a.createObserver(s, i) : le(e, { value: s }, i);
  }
}
function oe(e) {
...
var Ye = { beforeMount: le, updated: Ke, unmounted: oe };
function Xe(e) {
  return {
    all: (e = e || new Map()),
    on: function (t, i) {
...
var j = {
  ...
  directives: { ObserveVisibility: Ye },
  props: E(C({}, ce), {
  ...
  methods: {
    addView(e, t, i, s, r) {
      const a = Se({ id: tt++, index: t, used: !0, key: s, type: r }),
        l = $e({ item: i, position: 0, nr: a });
      return e.push(l), l;
    },
    unuseView(e, t = !1) {
    ...
    updateVisibleItems(e, t = !1) {
        ...
        if (i === null) {
          ...
          do
            (Y = b),
              ...
              m < c.start
                ? (V = b)
                : b < h - 1 && p[b + 1].accumulator > c.start && (K = b),
              (b = ~~((V + K) / 2));
          while (b !== Y);
          for (
            b < 0 && (b = 0), v = b, R = p[h - 1].accumulator, u = b;
      ...
      let d;
      const D = v <= this.$_endIndex && u >= this.$_startIndex;
      if (D)
        for (let c = 0, y = k.length; c < y; c++)
          (d = k[c]),
            d.nr.used &&
              (e && (d.nr.index = ue[d.item[o]]),
              (d.nr.index == null || d.nr.index < v || d.nr.index >= u) &&
                this.unuseView(d));
      const q = D ? null : new Map();
      let O, $, A;
      for (let c = v; c < u; c++) {
        O = n[c];
        const y = o ? O[o] : O;
...
const it = { key: 0, ref: "before", class: "vue-recycle-scroller__slot" },
  st = { key: 1, ref: "after", class: "vue-recycle-scroller__slot" };
function rt(e, t, i, s, r, a) {
  const l = se("ResizeObserver"),
    o = we("observe-visibility");
  return Ie(
    (_(),
    x(
      "div",
      ...
      [
        e.$slots.before
          ? (_(), x("div", it, [w(e.$slots, "before")], 512))
          : J("v-if", !0),
        (_(),
        U(
          Q(i.listTag),
          {
            ...
            class: Z(["vue-recycle-scroller__item-wrapper", i.listClass])
          },
          {
            default: T(() => [
              (_(!0),
                      ...
                      re(
                        {
                          ...
                          style: r.ready
                            ? {
                                ...
                                width: i.gridItems
                                  ? `${(e.direction === "vertical" && i.itemSecondarySize) || i.itemSize}px`
                                  : void 0,
                                height: i.gridItems
                                  ? `${(e.direction === "horizontal" && i.itemSecondarySize) || i.itemSize}px`
                                  : void 0
                              }
                            : null,
                          class: [
        ...
        e.$slots.after
          ? (_(), x("div", st, [w(e.$slots, "after")], 512))
          : J("v-if", !0),
        Oe(l, { onNotify: a.handleResize }, null, 8, ["onNotify"])
      ],
      34
    )),
            ...
            if (Array.isArray(e)) {
              for (const t of e)
                if (t.target && t.target.$_vs_onResize) {
                  ...
                  } else (i = t.contentRect.width), (s = t.contentRect.height);
    ...
    itemsWithSize() {
      ...
      for (let l = 0; l < a; l++) {
        const o = t[l],
          n = s ? l : o[i];
        let h = r[n];
        typeof h == "undefined" && !this.$_undefinedMap[n] && (h = 0),
      ...
      ),
      {
        default: T(({ item: o, index: n, active: h }) => [
          w(
            e.$slots,
            "default",
            De(Ae({ item: o.item, index: n, active: h, itemWithSize: o }))
          )
        ]),
