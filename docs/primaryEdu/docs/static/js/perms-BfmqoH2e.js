    ...
    setup(V) {
      ...
      return (D, e) => {
        ...
        return (
          d(),
          x("div", null, [
            a("p", P, "当前拥有的code列表：" + C(p(y)), 1),
            m(a("p", S, " *:*:* 代表拥有全部按钮级别权限 ", 512), [
              [N, ((w = p(y)) == null ? void 0 : w[0]) === "*:*:*"]
            ]),
            t(
              b,
              ...
              { shadow: "never", class: "mb-2" },
              {
                header: s(
                  () =>
                    e[5] ||
                    (e[5] = [
                      a("div", { class: "card-header" }, "函数方式判断权限", -1)
                    ])
                ),
                default: s(() => [
                  t(
