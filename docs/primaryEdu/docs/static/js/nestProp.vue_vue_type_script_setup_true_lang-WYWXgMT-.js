      ...
      const e = [
          {
            ...
            other: [
              { sex: "女" },
              {
                more: {
                  content:
                    '<div><span style="color: red">我是 html 片段</span></div>'
                }
              }
            ],
            role: "设计师"
        ...
        t = [
          { label: "姓名", prop: "userInfo.name" },
          { label: "性别", prop: "other[0].sex" },
          { label: "年龄", prop: "userInfo.age" },
          { label: "Html片段", slot: "content" },
          { label: "角色", prop: "role" }
        ];
      return (h, u) => {
        const o = l("pure-table");
        return (
          s(),
          a(
            o,
            ...
            {
              content: p(({ row: n }) => [
                m("span", { innerHTML: n.other[1].more.content }, null, 8, i)
              ]),
              _: 1
            }
          )
