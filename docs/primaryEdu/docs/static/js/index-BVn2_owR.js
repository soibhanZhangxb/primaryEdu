...
function gt(t, e, n) {
  ...
  return (document.cookie = s.join("; ")), St(t);
}
function St(t) {
  return ((e = {}),
...
function Gt(t, e) {
  e
    ...
    : gt(t._options.dontShowAgainCookie, "", -1);
}
var X,
  rt =
    ((X = {}),
...
function _t(t, e, n, o, i) {
  ...
  if (
    ...
    t &&
    ((r =
      e === "tooltip" ? i.getBoundingClientRect() : o.getBoundingClientRect()),
    !(function (a) {
...
function Q(t) {
  ...
  return (
    !(!e || e.nodeName === "HTML") && (at(t, "position") === "fixed" || Q(e))
  );
}
function B(t, e) {
  var n = document.body,
  ...
  return (e.tagName.toLowerCase() !== "body" && c === "relative") ||
    c === "sticky"
    ? Object.assign(p, { top: s.top - a.top, left: s.left - a.left })
    : Q(t)
      ? Object.assign(p, { top: s.top, left: s.left })
      : Object.assign(p, { top: s.top + i, left: s.left + r });
}
function ct(t, e) {
  if (t instanceof SVGElement) {
    var n = t.getAttribute("class") || "";
...
function N(t, e, n) {
  if (n && e) {
    var o = B(e.element, t._targetElement),
      i = t._options.helperElementPadding;
    e.element instanceof Element && Q(e.element)
      ? A(n, "introjs-fixedTooltip")
      : ct(n, "introjs-fixedTooltip"),
...
function zt(t, e, n, o) {
  var i = t.slice(),
    ...
    p = "floating";
  if (
    (c.bottom + s > r.height && j(i, "bottom"),
    c.top - s < 0 && j(i, "top"),
    c.right + a > r.width && j(i, "right"),
    c.left - a < 0 && j(i, "left"),
    o && (o = o.split("-")[0]),
    i.length && ((p = i[0]), i.includes(o) && (p = o)),
    p === "top" || p === "bottom")
  ) {
    var l = void 0,
      u = [];
    p === "top"
      ? ((l = "top-middle-aligned"),
        (u = ["top-left-aligned", "top-middle-aligned", "top-right-aligned"]))
      : ((l = "bottom-middle-aligned"),
        (u = [
          "bottom-left-aligned",
      ...
      (p =
        (function (d, v, _, w) {
          var y = v / 2,
            k = Math.min(_, window.screen.width);
          return (
            k - d < v &&
              (j(w, "top-left-aligned"), j(w, "bottom-left-aligned")),
            (d < y || k - d < y) &&
              (j(w, "top-middle-aligned"), j(w, "bottom-middle-aligned")),
            d < v && (j(w, "top-right-aligned"), j(w, "bottom-right-aligned")),
            w.length ? w[0] : null
          );
...
function J(t, e, n, o, i) {
  if ((i === void 0 && (i = !1), e)) {
    ...
    (n.style.top = ""),
      ...
      (p =
        typeof e.tooltipClass == "string"
          ? e.tooltipClass
          : t._options.tooltipClass),
      (n.className = ["introjs-tooltip", p].filter(Boolean).join(" ")),
      n.setAttribute("role", "dialog"),
      (c = e.position) !== "floating" &&
        t._options.autoPosition &&
        (c = zt(t._options.positionPrecedence, e.element, n, c)),
      (s = B(e.element)),
      (r = B(n)),
      (a = lt()),
      A(n, "introjs-".concat(c));
    var l = s.width / 2 - r.width / 2;
    switch (c) {
      case "top-right-aligned":
        o.className = "introjs-arrow bottom-right";
        var u = 0;
        $(s, u, r, n), (n.style.bottom = "".concat(s.height + 20, "px"));
        break;
      case "top-middle-aligned":
        (o.className = "introjs-arrow bottom-middle"),
          i && (l += 5),
          $(s, l, r, n) && ((n.style.right = ""), Y(s, l, r, a, n)),
...
function At(t, e) {
  var n = f("div", { className: "introjs-bullets" });
  ...
  for (
    ...
    a.setAttribute("role", "presentation"),
      ...
      (c.onclick = i),
      r === e.step - 1 && (c.className = "active"),
      G(c),
      (c.innerHTML = "&nbsp;"),
      c.setAttribute("data-step-number", s.toString()),
      a.appendChild(c),
      o.appendChild(a);
  }
      ...
      switch (R.label) {
        ...
        case 2:
          return (
            ...
            typeof e.highlightClass == "string" &&
              (i += " ".concat(e.highlightClass)),
            typeof t._options.highlightClass == "string" &&
              (i += " ".concat(t._options.highlightClass)),
            n !== null && o !== null
              ? ((c = o.querySelector(".introjs-helperNumberLayer")),
                (p = o.querySelector(".introjs-tooltiptext")),
                (l = o.querySelector(".introjs-tooltip-title")),
                (u = o.querySelector(".introjs-arrow")),
                (d = o.querySelector(".introjs-tooltip")),
                ...
                vt(t._options.scrollToElement, e.element),
                N(t, e, n),
                N(t, e, o),
                kt(),
                  ...
                  c !== null &&
                    ...
                    (function (h, C, S) {
                      if (h) {
                        ...
                        M &&
                          ft &&
                          ((M.className = ""), (ft.className = "active"));
                      }
                    })(t._options.showBullets, o, e),
                    xt(o, t._currentStep, t._introItems.length),
                    (d.style.opacity = "1"),
                    ((r != null && /introjs-donebutton/gi.test(r.className)) ||
                      r != null) &&
                      r.focus(),
                    _t(
              ...
              : ((v = f("div", { className: i })),
                (_ = f("div", { className: "introjs-tooltipReferenceLayer" })),
                (w = f("div", { className: "introjs-arrow" })),
                (y = f("div", { className: "introjs-tooltip" })),
                (k = f("div", { className: "introjs-tooltiptext" })),
                (I = f("div", { className: "introjs-tooltip-header" })),
                (O = f("h1", { className: "introjs-tooltip-title" })),
                (q = f("div")),
                E(v, {
                  "box-shadow":
                ...
                N(t, e, v),
                N(t, e, _),
                yt(t._targetElement, v, !0),
                yt(t._targetElement, _),
                (k.innerHTML = e.intro),
                (O.innerHTML = e.title),
                (q.className = "introjs-tooltipbuttons"),
                t._options.showButtons === !1 && (q.style.display = "none"),
                I.appendChild(O),
                y.appendChild(I),
                y.appendChild(k),
                t._options.dontShowAgain &&
                  ((z = f("div", { className: "introjs-dontShowAgain" })),
                  ((dt = f("input", {
                    type: "checkbox",
                  ...
                  z.appendChild(ht),
                  y.appendChild(z)),
                y.appendChild(At(t, e)),
                y.appendChild(
                  (function (h) {
                    var C = f("div");
                    (C.className = "introjs-progress"),
                      h._options.showProgress === !1 &&
                        (C.style.display = "none");
                    var S = f("div", { className: "introjs-progressbar" });
                    h._options.progressBarAdditionalClass &&
                      (S.className +=
                        " " + h._options.progressBarAdditionalClass);
                    var M = jt(h._currentStep, h._introItems.length);
                    return (
                      S.setAttribute("role", "progress"),
                      S.setAttribute("aria-valuemin", "0"),
                      S.setAttribute("aria-valuemax", "100"),
                      S.setAttribute("aria-valuenow", M.toString()),
                      (S.style.cssText = "width:".concat(M, "%;")),
                      C.appendChild(S),
                      C
                    );
                  })(t)
                ...
                y.appendChild(w),
                _.appendChild(y),
                ((r = f("a")).onclick = function () {
                  return m(nt, void 0, void 0, function () {
                ...
                ((s = f("a")).onclick = function () {
                  return m(nt, void 0, void 0, function () {
                    return b(this, function (h) {
                      switch (h.label) {
                        case 0:
                          return t._currentStep > 0 ? [4, K(t)] : [3, 2];
                        case 1:
                          h.sent(), (h.label = 2);
                        case 2:
                          return [2];
                ...
                G((a = f("a", { className: "introjs-skipbutton" }))),
                ...
                I.appendChild(a),
                t._introItems.length > 1 && q.appendChild(s),
                q.appendChild(r),
                y.appendChild(q),
                J(t, e, y, w),
                _t(
            ...
            (U = t._targetElement.querySelector(
            ...
            e.disableInteraction &&
              (function (h, C) {
                ...
                S === null &&
                  ((S = f("div", { className: "introjs-disableInteraction" })),
    ...
    return b(this, function (n) {
      switch (n.label) {
        case 0:
          return (
            (t._currentStep = e - 2),
            t._introItems === void 0 ? [3, 2] : [4, T(t)]
          );
        case 1:
          n.sent(), (n.label = 2);
        case 2:
    ...
    return b(this, function (o) {
      switch (o.label) {
        ...
        case 1:
          (n = o.sent()), (o.label = 2);
        case 2:
          return n === !1 ? (++t._currentStep, [2, !1]) : [4, Nt(t, e)];
        case 3:
          return o.sent(), [2, !0];
      }
    });
    ...
    return b(this, function (i) {
      switch (i.label) {
        ...
        case 1:
          return i.sent(), [3, 16];
        case 2:
          return n !== "ArrowLeft" && n !== 37 ? [3, 4] : [4, K(t)];
        case 3:
          return i.sent(), [3, 16];
        case 4:
        ...
        case 11:
          return i.sent(), [3, 15];
        case 12:
          return o && o.getAttribute("data-step-number")
            ? (o.click(), [3, 15])
            : [3, 13];
        case 13:
          return [4, T(t)];
...
function ut(t) {
  if (t === null || Z(t) !== "object" || "nodeType" in t) return t;
  var e = {};
  for (var n in t)
    "jQuery" in window && t[n] instanceof window.jQuery
      ? (e[n] = t[n])
      : (e[n] = ut(t[n]));
  return e;
}
  ...
  return m(this, void 0, void 0, function () {
    ...
    return b(this, function (o) {
      switch (o.label) {
        case 0:
          return (
            (n = H('.introjs-hint[data-step="'.concat(e, '"]'))[0]),
            tt(),
            n && A(n, "introjs-hidehint"),
            g(t._hintCloseCallback)
              ? [4, t._hintCloseCallback.call(t, e)]
              : [3, 2]
          );
        case 1:
          o.sent(), (o.label = 2);
...
function Xt(t) {
  return m(this, void 0, void 0, function () {
    ...
    return b(this, function (s) {
      switch (s.label) {
        case 0:
          (e = H(".introjs-hint")), (n = 0), (o = e), (s.label = 1);
        case 1:
          return n < o.length
            ? ((i = o[n]),
              (r = i.getAttribute("data-step"))
                ? [4, pt(t, parseInt(r, 10))]
                : [3, 3])
            : [3, 4];
        case 2:
          s.sent(), (s.label = 3);
...
function Yt(t) {
  return m(this, void 0, void 0, function () {
    ...
    return b(this, function (s) {
      switch (s.label) {
        case 0:
          if (!(e = H(".introjs-hint")) || !e.length) return [3, 1];
          for (n = 0, o = e; n < o.length; n++)
            (i = o[n]),
              (r = i.getAttribute("data-step")) && Tt(parseInt(r, 10));
          return [3, 3];
        case 1:
          return [4, qt(t, t._targetElement)];
        case 2:
          s.sent(), (s.label = 3);
        case 3:
          return [2];
...
function Tt(t) {
  var e = H('.introjs-hint[data-step="'.concat(t, '"]'))[0];
  e && ct(e, /introjs-hidehint/g);
}
function wt(t) {
  var e = H('.introjs-hint[data-step="'.concat(t, '"]'))[0];
        ...
        case 0:
          for (
            (e = document.querySelector(".introjs-hints")) === null &&
              (e = f("div", { className: "introjs-hints" })),
              n = function (d) {
                return function (v) {
                  var _ = v || window.event;
                  _ && _.stopPropagation && _.stopPropagation(),
                    _ && _.cancelBubble !== null && (_.cancelBubble = !0),
                    It(t, d);
                };
              },
              o = 0;
            ...
            if (
              ...
              return [2];
            G((r = f("a", { className: "introjs-hint" }))),
              (r.onclick = n(o)),
              i.hintAnimation || A(r, "introjs-hint-no-anim"),
              Q(i.element) && A(r, "introjs-fixedhint"),
              (s = f("div", { className: "introjs-hint-dot" })),
              (a = f("div", { className: "introjs-hint-pulse" })),
              r.appendChild(s),
              r.appendChild(a),
              r.setAttribute("data-step", o.toString()),
              (i.hintTargetElement = i.element),
              (i.element = r),
              Lt(i.hintPosition, r, i.hintTargetElement),
              e.appendChild(r);
          }
          return (
            document.body.appendChild(e),
            g(t._hintsAddedCallback)
          ...
          return (
            t._options.hintAutoRefreshInterval >= 0 &&
              ((t._hintsAutoRefreshFunction =
                ...
                (l = t._options.hintAutoRefreshInterval),
                function () {
      ...
      switch (v.label) {
        case 0:
          return (
            ...
            (o = t._hintItems[e]),
            g(t._hintClickCallback)
              ? [4, t._hintClickCallback.call(t, n, o, e)]
              : [3, 2]
          );
        case 1:
          v.sent(), (v.label = 2);
        case 2:
          return (
            ((i = tt()) !== void 0 && parseInt(i, 10) === e) ||
              ((r = f("div", { className: "introjs-tooltip" })),
              (s = f("div")),
              (a = f("div")),
              (c = f("div")),
              ...
              ((p = f("p")).innerHTML = o.hint || ""),
              s.appendChild(p),
              t._options.hintShowButton &&
                (((l = f("a")).className = t._options.buttonClass),
                l.setAttribute("role", "button"),
                (l.innerHTML = t._options.hintButtonLabel),
                (l.onclick = function () {
                  return pt(t, e);
                }),
                s.appendChild(l)),
              ...
              r.appendChild(a),
              r.appendChild(s),
              (u = n.getAttribute("data-step") || ""),
              (t._currentStep = parseInt(u, 10)),
              (d = t._hintItems[t._currentStep]),
              (c.className =
                "introjs-tooltipReferenceLayer introjs-hintReference"),
              c.setAttribute("data-step", u),
              N(t, d, c),
              c.appendChild(r),
      ...
      switch (d.label) {
        case 0:
          if (
            ...
            if (
              !(s = Array.from(e.querySelectorAll("*[data-hint]"))) ||
              !s.length
            )
              return [2, !1];
            for (a = 0, c = s; a < c.length; a++)
              (p = c[a]),
                (l = p.getAttribute("data-hint-animation")),
                (u = t._options.hintAnimation),
                l && (u = l === "true"),
                t._hintItems.push({
                  element: p,
        ...
        case 1:
          return (
            d.sent(),
            x.on(document, "click", tt, t, !1),
            x.on(window, "resize", et, t, !0),
            [2, !0]
          );
      }
    });
...
function Pt(t, e) {
  ...
  if (t._options.steps && t._options.steps.length)
    for (var i = 0, r = t._options.steps; i < r.length; i++) {
      ...
      if (
        ...
        a === null &&
          ((a = f("div", { className: "introjsFloatingElement" })),
    ...
    for (var p = 0, l = n; p < l.length; p++) {
      ...
      if (
        (!t._options.group ||
          u.getAttribute("data-intro-group") === t._options.group) &&
        u.style.display !== "none"
      ) {
        var d = parseInt(u.getAttribute("data-step") || "", 10);
        (c = t._options.disableInteraction),
          u.hasAttribute("data-disable-interaction") &&
            (c = !!u.getAttribute("data-disable-interaction")),
          d > 0 &&
            (o[d - 1] = {
              step: d,
              element: u,
              title: u.getAttribute("data-title") || "",
              intro: u.getAttribute("data-intro") || "",
              tooltipClass: u.getAttribute("data-tooltip-class") || void 0,
              highlightClass: u.getAttribute("data-highlight-class") || void 0,
              position:
                u.getAttribute("data-position") || t._options.tooltipPosition,
              scrollTo: u.getAttribute("data-scroll-to") || t._options.scrollTo,
              disableInteraction: c
            });
      }
    }
    for (var v = 0, _ = 0, w = n; _ < w.length; _++)
      if (
        ((u = w[_]),
        (!t._options.group ||
          u.getAttribute("data-intro-group") === t._options.group) &&
          u.getAttribute("data-step") === null)
      ) {
        for (; o[v] !== void 0; ) v++;
        (c = u.hasAttribute("data-disable-interaction")
          ? !!u.getAttribute("data-disable-interaction")
  ...
  for (var y = [], k = 0; k < o.length; k++) o[k] && y.push(o[k]);
  return (
    (o = y).sort(function (I, O) {
...
function Bt(t, e) {
  ...
  if (n != null && n != -1) {
    ...
    N(t, o, r),
      ...
      N(t, o, s),
      e &&
        ((t._introItems = Pt(t, t._targetElement)),
        (function (p, l) {
          if (p._options.showBullets) {
            var u = document.querySelector(".introjs-bullets");
            u && u.parentNode && u.parentNode.replaceChild(At(p, l), u);
          }
        })(t, o),
        xt(i, n, t._introItems.length));
    var a = document.querySelector(".introjs-arrow"),
      c = document.querySelector(".introjs-tooltip");
    return c && a && J(t, t._introItems[n], c, a), et(t), t;
  }
}
function Ht(t) {
  Bt(t);
      ...
      return b(this, function (a) {
        switch (a.label) {
          ...
          case 2:
            if (!n && o === !1) return [2];
            if (
              (i = Array.from(e.querySelectorAll(".introjs-overlay"))) &&
              i.length
            )
              for (r = 0, s = i; r < s.length; r++) F(s[r]);
            return (
              F(e.querySelector(".introjs-helperLayer"), !0),
              F(e.querySelector(".introjs-tooltipReferenceLayer")),
              F(e.querySelector(".introjs-disableInteraction")),
              F(document.querySelector(".introjsFloatingElement")),
              kt(),
              x.off(window, "keydown", Et, t, !0),
              x.off(window, "resize", Ht, t, !0),
              g(t._introExitCallback)
    ...
    return b(this, function (o) {
      switch (o.label) {
        ...
        case 1:
          o.sent(), (o.label = 2);
        case 2:
          return (n = Pt(t, e)).length === 0
            ? [2, !1]
            : ((t._introItems = n),
              (function (i, r) {
                var s = this,
                  a = f("div", { className: "introjs-overlay" });
                E(a, {
                  top: 0,
                  bottom: 0,
                  left: 0,
        ...
        case 3:
          o.sent(),
            e.addEventListener,
            t._options.keyboardNavigation && x.on(window, "keydown", Et, t, !0),
            x.on(window, "resize", Ht, t, !0),
            (o.label = 4);
        case 4:
          return [2, !1];
      }
...
var it = (function () {
    ...
    return (
      (t.prototype.isActive = function () {
        return (
          (!this._options.dontShowAgain ||
            (e = St(this._options.dontShowAgainCookie)) === "" ||
            e !== "true") &&
      ...
      (t.prototype.setOption = function (e, n) {
        return (this._options = Ct(this._options, e, n)), this;
      }),
      ...
      (t.prototype.start = function () {
        return m(this, void 0, void 0, function () {
          return b(this, function (e) {
            switch (e.label) {
              case 0:
                return [4, Zt(this, this._targetElement)];
              case 1:
      ...
      (t.prototype.addHints = function () {
        return m(this, void 0, void 0, function () {
          return b(this, function (e) {
            switch (e.label) {
              case 0:
                return [4, qt(this, this._targetElement)];
              case 1:
                return e.sent(), [2, this];
            }
          });
      ...
      (t.prototype.removeHints = function () {
        return (
          (function (e) {
            for (var n = 0, o = H(".introjs-hint"); n < o.length; n++) {
              var i = o[n].getAttribute("data-step");
              i && wt(parseInt(i, 10));
            }
            x.off(document, "click", tt, e, !1),
              x.off(window, "resize", et, e, !0),
  ...
  st = function t(e) {
    var n;
    if (Z(e) === "object") n = new it(e);
    else if (typeof e == "string") {
      var o = document.querySelector(e);
      if (!o) throw new Error("There is no element with given selector.");
      n = new it(o);
    } else n = new it(document.body);
    return (t.instances[rt(n, "introjs-instance")] = n), n;
  };
(st.version = "7.2.0"), (st.instances = {});
const Kt = Ot({
  name: "Guide",
  __name: "index",
  setup(t) {
              ...
              D(
                ...
                },
                {
                  default: P(
                    () =>
                      s[1] ||
                      (s[1] = [ot(" 代码位置 src/views/guide/index.vue ")])
                  ),
                  _: 1,
                  __: [1]
                }
