...
const o =
  ...
  pe = (0, o.defineComponent)({
    ...
    render: function () {
      var e = this.nodeType,
        t = this.onClick,
        n = e === "objectStart" || e === "arrayStart";
      return n || e === "objectCollapsed" || e === "arrayCollapsed"
        ? (0, o.createVNode)(
            "span",
            {
...
function O(e) {
  ...
  if (V === "array") {
    var T = $(
      e.map(function (g, u, r) {
        return O(g, "".concat(t, "[").concat(u, "]"), n + 1, {
          index: u,
          showComma: u !== r.length - 1,
          length: S,
          type: b
        });
      })
    ...
    return [
      ...
      T,
      O("]", t, n, { showComma: N, length: e.length, type: "arrayEnd" })[0]
    );
  }
  if (V === "object") {
    var j = Object.keys(e),
      x = $(
        j.map(function (g, u, r) {
          return O(
            e[g],
            /^[a-zA-Z_]\w*$/.test(g)
              ? "".concat(t, ".").concat(g)
              : "".concat(t, '["').concat(g, '"]'),
            n + 1,
            { key: g, showComma: u !== r.length - 1, length: S, type: b }
          );
        })
      );
    return [
      ...
      x,
      O("}", t, n, { showComma: N, length: j.length, type: "objectEnd" })[0]
    );
  }
  return [
    {
...
function $(e) {
  ...
  for (var t = E(e), n = []; t.length; ) {
    var l = t.shift();
    Array.isArray(l) ? t.unshift.apply(t, E(l)) : n.push(l);
  }
  return n;
}
function Q(e) {
  ...
  setup: function (e, t) {
    var n = t.emit,
      l = (0, o.computed)(function () {
        return X(e.node.content);
      }),
      p = (0, o.computed)(function () {
      ...
      b = (0, o.computed)(function () {
        return e.nodeSelectable(e.node) && (C.value || d.value);
      }),
      f = (0, o.reactive)({ editing: !1 }),
      N = function (u) {
        var r,
          a,
          c =
            (a = (r = u.target) === null || r === void 0 ? void 0 : r.value) ===
            "null"
              ? null
              : a === "undefined"
                ? void 0
                  ...
                  (a !== "false" &&
                    ...
                    a[0] + a[a.length - 1] === "''"
                      ...
                      : (typeof Number(a) == "number" && !isNaN(Number(a))) ||
                        ...
                        ? Number(a)
                        : a));
        n("valueChange", c, e.node.path);
      },
      w = (0, o.computed)(function () {
        var u,
          r = (u = e.node) === null || u === void 0 ? void 0 : u.content;
        return (
          r === null ? (r = "null") : r === void 0 && (r = "undefined"),
          l.value === "string" ? '"'.concat(r, '"') : r + ""
        );
      }),
      S = function () {
        var u = e.renderNodeValue;
        return u ? u({ node: e.node, defaultValue: w.value }) : w.value;
      },
      V = function () {
      ...
      x = function () {
        n("nodeClick", e.node),
          b.value && e.selectOnClickNode && n("selectedChange", e.node);
      },
      g = function (u) {
        if (e.editable && !f.editing) {
          ...
          var r = function a(c) {
            var i;
            c.target !== u.target &&
              ((i = c.target) === null || i === void 0
                ? void 0
                : i.parentElement) !== u.target &&
              ((f.editing = !1), document.removeEventListener("click", a));
          };
    ...
    return function () {
      ...
      return (0, o.createVNode)(
        ...
        [
          e.showLineNumber &&
            (0, o.createVNode)("span", { class: "vjs-node-index" }, [r.id + 1]),
          e.showSelectController &&
            ...
            (0, o.createVNode)(
              de,
              { isMultiple: C.value, checked: e.checked, onChange: j },
              null
            ),
          (0, o.createVNode)("div", { class: "vjs-indent" }, [
            Array.from(Array(r.level)).map(function (a, c) {
              return (0, o.createVNode)(
                "div",
                {
                  key: c,
                  class: { "vjs-indent-unit": !0, "has-line": e.showLine }
                },
                null
              );
            }),
            e.showIcon &&
              (0, o.createVNode)(pe, { nodeType: r.type, onClick: T }, null)
          ]),
          r.key &&
            (0, o.createVNode)("span", { class: "vjs-key" }, [
              ((u = e.renderNodeKey),
              u ? u({ node: e.node, defaultKey: y.value || "" }) : y.value),
              (0, o.createVNode)("span", { class: "vjs-colon" }, [
                ":".concat(e.showKeyValueSpace ? " " : "")
              ])
            ]),
          (0, o.createVNode)("span", null, [
            r.type !== "content" && r.content
              ? (0, o.createVNode)(
                  se,
                  { data: r.content.toString(), onClick: V },
                  null
                )
              : (0, o.createVNode)(
                  "span",
            ...
            r.showComma && (0, o.createVNode)("span", null, [","]),
            e.showLength &&
              e.collapsed &&
              (0, o.createVNode)("span", { class: "vjs-comment" }, [
                (0, o.createTextVNode)(" // "),
                r.length,
                (0, o.createTextVNode)(" items ")
              ])
          ])
        ]
      );
...
function v(e) {
  for (var t = 1; t < arguments.length; t++) {
    var n = arguments[t] != null ? arguments[t] : {};
    t % 2
      ? U(Object(n), !0).forEach(function (l) {
          D(e, l, n[l]);
        })
      : Object.getOwnPropertyDescriptors
        ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(n))
        : U(Object(n)).forEach(function (l) {
            Object.defineProperty(e, l, Object.getOwnPropertyDescriptor(n, l));
          });
  }
  return e;
}
const fe = (0, o.defineComponent)({
  name: "Tree",
  props: v(
    v({}, ee),
    {},
  ...
  setup: function (e, t) {
    var n = t.emit,
      ...
      C = function (r, a) {
        return y.value.reduce(function (c, i) {
          var s,
            h = i.level >= r || i.length >= a,
            m =
              (s = e.pathCollapsible) === null || s === void 0
                ? void 0
                : s.call(e, i);
          return (i.type !== "objectStart" && i.type !== "arrayStart") ||
            (!h && !m)
            ? c
            : v(v({}, c), {}, D({}, i.path, 1));
        }, {});
      ...
      d = (0, o.reactive)({
        translateY: 0,
        visibleData: null,
        hiddenPaths: C(e.deep, e.collapsedNodeLength)
      }),
      b = (0, o.computed)(function () {
        for (var r = null, a = [], c = y.value.length, i = 0; i < c; i++) {
          var s = v(v({}, y.value[i]), {}, { id: i }),
            h = d.hiddenPaths[s.path];
          if (r && r.path === s.path) {
            var m = r.type === "objectStart",
              B = v(
                v(v({}, s), r),
                {},
                {
                  showComma: s.showComma,
                  content: m ? "{...}" : "[...]",
                  type: m ? "objectCollapsed" : "arrayCollapsed"
                }
              );
            (r = null), a.push(B);
          } else {
      ...
      f = (0, o.computed)(function () {
        var r = e.selectedValue;
        return r && e.selectableType === "multiple" && Array.isArray(r)
          ? r
          : [r];
      }),
      ...
      w = function () {
        ...
        if (e.virtual) {
          var a,
            ...
            i =
              ((a = p.value) === null || a === void 0 ? void 0 : a.scrollTop) ||
              0,
            s = Math.floor(i / e.itemHeight),
            h = s < 0 ? 0 : s + c > r.length ? r.length - c : s;
          h < 0 && (h = 0);
          var m = h + c;
          (d.translateY = h * e.itemHeight),
            (d.visibleData = r.filter(function (B, L) {
              return L >= h && L < m;
            }));
        } else d.visibleData = r;
      },
      S = function () {
        w();
      },
      V = function (r) {
        var a,
          ...
          s = e.selectableType;
        if (s === "multiple") {
          var h = f.value.findIndex(function (k) {
              return k === i;
            }),
            m = E(f.value);
          h !== -1 ? m.splice(h, 1) : m.push(i),
            n("update:selectedValue", m),
            n("selectedChange", m, E(f.value));
        } else if (s === "single" && f.value[0] !== i) {
          var B = ((a = f.value),
            (c = 1),
            (function (k) {
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
            ...
            L = i;
          n("update:selectedValue", L), n("selectedChange", L, B);
        }
      },
      T = function (r) {
        n("nodeClick", r);
      ...
      j = function (r, a) {
        if (r) d.hiddenPaths = v(v({}, d.hiddenPaths), {}, D({}, a, 1));
        else {
          var c = v({}, d.hiddenPaths);
          delete c[a], (d.hiddenPaths = c);
        }
      },
      x = function (r, a) {
        e.collapsedOnClickBrackets && j(r, a.path), n("bracketsClick", r, a);
      },
      g = function (r, a) {
        j(r, a.path), n("iconClick", r, a);
      },
      u = function (r, a) {
        var c = Q(e.data),
          i = e.rootPath;
        new Function("data", "val", "data".concat(a.slice(i.length), "=val"))(
          c,
          r
        ),
          n("update:data", c);
    ...
    return (
      ...
      (0, o.watch)(
        ...
        function (r) {
          r && (d.hiddenPaths = C(r, e.collapsedNodeLength));
        }
      ),
      (0, o.watch)(
        function () {
      ...
      function () {
        var r,
          a,
          c =
            (r = e.renderNodeKey) !== null && r !== void 0
              ? r
              : l.renderNodeKey,
          i =
          ...
          s =
            d.visibleData &&
            d.visibleData.map(function (h) {
              return (0, o.createVNode)(
                he,
                {
                  key: h.id,
                  node: h,
                  collapsed: !!d.hiddenPaths[h.path],
                  theme: e.theme,
                  showDoubleQuotes: e.showDoubleQuotes,
                  showLength: e.showLength,
                  checked: f.value.includes(h.path),
          ...
          "div",
          {
            ...
            style: e.showLineNumber
              ? v(
                  {
                    paddingLeft: "".concat(
                      12 * Number(y.value.length.toString().length),
                      "px"
                    )
                  },
                  e.style
                  ...
                  [
                    (0, o.createVNode)(
                      "div",
                      {
                        ...
                        style: {
                          height: "".concat(b.value.length * e.itemHeight, "px")
                        }
                      },
                      [
                        (0, o.createVNode)(
