...
var yt = (t, e, n) =>
    e in t
      ...
      : (t[e] = n),
  K = (t, e) => {
    for (var n in e || (e = {})) pn.call(e, n) && yt(t, n, e[n]);
    if (_t) for (var n of _t(e)) mn.call(e, n) && yt(t, n, e[n]);
    return t;
  },
  Ee = (t, e) => fn(t, hn(e));
import { S as Et, a as gn } from "./sortable.esm-VSgMS8pS.js";
import {
  h as De,
  J as vn,
  d as Yt,
...
import { u as xt } from "./app-Cei5Vfyo.js";
/**!
 * Sortable 1.14.0
...
function U(t) {
  for (var e = 1; e < arguments.length; e++) {
    ...
    e % 2
      ? Tt(Object(n), !0).forEach(function (o) {
          Sn(t, o, n[o]);
        })
...
var Q = Z(/(?:Trident.*rv[ :]?11\.|msie|iemobile|Windows Phone)/i),
  Ne = Z(/Edge/i),
  It = Z(/firefox/i),
  Te = Z(/safari/i) && !Z(/chrome/i) && !Z(/android/i),
  Ht = Z(/iP(ad|od|hone)/i),
  In = Z(/chrome/i) && Z(/android/i),
  jt = { capture: !1, passive: !1 };
function _(t, e, n) {
  t.addEventListener(e, n, !Q && jt);
}
function b(t, e, n) {
  t.removeEventListener(e, n, !Q && jt);
}
function Ge(t, e) {
  if (e) {
...
function G(t, e, n, o) {
  if (t) {
    ...
    do {
      if (
        (e != null &&
          (e[0] === ">" ? t.parentNode === n && Ge(t, e) : Ge(t, e))) ||
        (o && t === n)
      )
        return t;
      if (t === n) break;
  ...
  if (!(!t.getBoundingClientRect && t !== window)) {
    ...
    if (o && t !== window) {
      var w = me(r || t),
        v = w && w.a,
        y = w && w.d;
      w && ((a /= y), (l /= v), (f /= v), (c /= y), (s = a + c), (u = l + f));
    }
    return { top: a, left: l, bottom: s, right: u, width: f, height: c };
  }
}
function At(t, e, n) {
  for (var o = re(t, !0), r = x(t)[e]; o; ) {
    var i = x(o)[n],
      a = void 0;
    if (((a = r >= i), !a)) return o;
    if (o === z()) break;
...
function gt(t, e) {
  for (
    ...
    n && (n === p.ghost || h(n, "display") === "none" || (e && !Ge(n, e)));
...
var ce = [],
  tt = { initializeByDefault: !0 },
  Fe = {
    mount: function (e) {
      for (var n in tt) tt.hasOwnProperty(n) && !(n in e) && (e[n] = tt[n]);
    ...
    pluginEvent: function (e, n, o) {
      ...
      ce.forEach(function (a) {
        n[a.pluginName] &&
          (n[a.pluginName][i] && n[a.pluginName][i](U({ sortable: n }, o)),
          n.options[a.pluginName] &&
            n[a.pluginName][e] &&
            n[a.pluginName][e](U({ sortable: n }, o)));
      });
    },
      ...
      return (
        ce.forEach(function (r) {
          typeof r.eventProperties == "function" &&
            J(o, r.eventProperties.call(n[r.pluginName], e));
        }),
        o
      );
    },
...
function Ln(t) {
  ...
  if (((e = e || (n && n[R])), !!e)) {
    var y,
      B = e.options,
      $ = "on" + o.charAt(0).toUpperCase() + o.substr(1);
    window.CustomEvent && !Q && !Ne
      ...
      (y.oldIndex = s),
      (y.newIndex = u),
      (y.oldDraggableIndex = c),
      (y.newDraggableIndex = f),
      (y.originalEvent = m),
      (y.pullMode = w ? w.lastPutMode : void 0);
    var A = U(U({}, v), Fe.getEventProperties(o, e));
    for (var Y in A) y[Y] = A[Y];
    n && n.dispatchEvent(y), B[$] && B[$].call(e, y);
  }
}
var Rn = ["evt"],
  N = function (e, n) {
...
var d,
  ...
  ct = !1,
  $e = [],
  Ke = typeof document != "undefined",
  Xe = Ht,
  Mt = Ne || Q ? "cssFloat" : "float",
  Xn = Ke && !In && !Ht && "draggable" in document.createElement("div"),
  $t = (function () {
    if (Ke) {
      if (Q) return !1;
...
function p(t, e) {
  ...
  (this.el = t), (this.options = e = J({}, e)), (t[R] = this);
  var n = {
    group: null,
    sort: !0,
    disabled: !1,
...
p.prototype = {
    ...
    if (e.cancelable) {
      ...
      if (
        ...
        !d &&
          ...
          ((s = G(s, r.draggable, o, !1)), !(s && s.animated) && Ve !== s))
      ) {
        if (((pe = X(s)), (Oe = X(s, r.draggable)), typeof c == "function")) {
      ...
      if (
        ...
        (s = function () {
          ...
          r._disableDelayedDragEvents(),
            !It && r.nativeDraggable && (d.draggable = !0),
        ...
        a.delay &&
          ...
          (!this.nativeDraggable || !(Ne || Q)))
      ) {
        if (p.eventCanceled) {
          this._onDrop();
          return;
        }
        _(l, "mouseup", r._disableDelayedDrag),
          _(l, "touchend", r._disableDelayedDrag),
          _(l, "touchcancel", r._disableDelayedDrag),
          _(l, "mousemove", r._delayedDragTouchMoveHandler),
          _(l, "touchmove", r._delayedDragTouchMoveHandler),
          a.supportPointer &&
            _(l, "pointermove", r._delayedDragTouchMoveHandler),
  ...
  _triggerDragStart: function (e, n) {
    (n = n || (e.pointerType == "touch" && e)),
      !this.nativeDraggable || n
        ...
        : (_(d, "dragend", this), _(E, "dragstart", this._onDragStart));
    try {
      document.selection
        ? je(function () {
  ...
  _emulateDragOver: function () {
    if (H) {
      (this._lastX = H.clientX), (this._lastY = H.clientY), Zt();
      for (
        var e = document.elementFromPoint(H.clientX, H.clientY), n = e;
        e &&
        e.shadowRoot &&
        ((e = e.shadowRoot.elementFromPoint(H.clientX, H.clientY)), e !== n);
  ...
  _onTouchMove: function (e) {
    if (se) {
      var n = this.options,
        ...
        u = Xe && O && Pt(O),
        c =
          (i.clientX - se.clientX + r.x) / (l || 1) +
          (u ? u[0] - rt[0] : 0) / (l || 1),
        f =
          (i.clientY - se.clientY + r.y) / (s || 1) +
          (u ? u[1] - rt[1] : 0) / (s || 1);
      if (!p.active && !he) {
        if (
          o &&
  ...
  _appendGhost: function () {
    if (!g) {
      ...
      (g = d.cloneNode(!0)),
        ...
        h(g, "height", n.height),
        h(g, "opacity", "0.8"),
        h(g, "position", Xe ? "absolute" : "fixed"),
        h(g, "zIndex", "100000"),
        ...
        h(
          g,
          "transform-origin",
          (Nt / parseInt(g.style.width)) * 100 +
            "% " +
            (Ft / parseInt(g.style.height)) * 100 +
            "%"
        );
    }
  },
  _onDragStart: function (e, n) {
    ...
    N("setupClone", this),
      ...
      (he = !0),
      (o._dragStartId = je(o._dragStarted.bind(o, n, e))),
      _(document, "selectstart", o),
      (Se = !0),
      Te && h(document.body, "user-select", "none");
  },
  _onDragOver: function (e) {
        ...
        U(
          {
            ...
            target: o,
            completed: A,
            onMove: function (wt, dn) {
              return Be(E, n, d, r, wt, x(wt), e, dn);
            },
            changed: Y
          },
          un
    ...
    function A(ye) {
      return (
        B("dragOverCompleted", { insertion: ye }),
        ye &&
        ...
        ((o === d && !d.animated) || (o === n && !o.animated)) && (fe = null),
        !l.dragoverBubble &&
          !e.rootEl &&
          o !== document &&
          (d.parentNode[R]._isOutsideThisEl(e.target), !ye && ue(e)),
    ...
    if (
      ...
      u &&
        ...
        (c
          ? f || (a = D !== E)
          : T === this ||
            ((this.lastPutMode = Le.checkPull(this, u, d, e)) &&
      ...
      if (a)
        return (
          ...
          this._hideClone(),
          B("revert"),
          p.eventCanceled || (de ? E.insertBefore(d, de) : E.appendChild(d)),
          A(!0)
        );
      var j = gt(n, l.draggable);
      if (!j || (Gn(e, w, this) && !j.animated)) {
        if (j === d) return A(!1);
        if (
          (j && n === e.target && (o = j),
          o && (i = x(o)),
          Be(E, n, d, r, o, i, e, !!o) !== !1)
        )
          return $(), n.appendChild(d), (D = n), Y(), A(!0);
      } else if (j && Wn(e, w, this)) {
        var ie = ge(n, 0, l, !0);
        if (ie === d) return A(!1);
        if (((o = ie), (i = x(o)), Be(E, n, d, r, o, i, e, !1) !== !1))
          return $(), n.insertBefore(d, ie), (D = n), Y(), A(!0);
        ...
        var W = 0,
          ...
          be = w ? "top" : "left",
          ee = At(o, "top", "top") || At(d, "top", "top"),
          we = ee ? ee.scrollTop : void 0;
        fe !== o &&
          ((ae = i[be]), (Pe = !1), (Re = (!F && l.invertSwap) || ve)),
          (W = zn(
            e,
            o,
            i,
        ...
        if (W !== 0) {
          var le = X(d);
          do (le -= W), (q = D.children[le]);
          while (q && (h(q, "display") === "none" || q === g));
        }
        if (W === 0 || q === o) return A(!1);
        (fe = o), (Ae = W);
        var _e = o.nextElementSibling,
          te = !1;
        te = W === 1;
        var Me = Be(E, n, d, r, o, i, e, te);
        if (Me !== !1)
          return (
            (Me === 1 || Me === -1) && (te = Me === 1),
            (ct = !0),
            ...
            te && !_e
              ? n.appendChild(d)
              : o.parentNode.insertBefore(d, te ? _e : o),
            ee && zt(ee, 0, we - ee.scrollTop),
            (D = d.parentNode),
            ae !== void 0 && !Re && (He = Math.abs(ae - x(o)[be])),
            Y(),
            A(!0)
          );
      }
      if (n.contains(d)) return A(!1);
    }
    return !1;
  },
  ...
  _offMoveEvents: function () {
    b(document, "mousemove", this._onTouchMove),
      ...
      b(document, "mousemove", ue),
      b(document, "touchmove", ue);
  },
  ...
  _onDrop: function (e) {
    ...
    (he = !1),
      ...
      this._offMoveEvents(),
      this._offUpEvents(),
      Te && h(document.body, "user-select", ""),
      h(d, "transform", ""),
      e &&
        (Se &&
          (e.cancelable && e.preventDefault(),
    ...
    for (
      ...
      (n = o[r]),
        G(n, a.draggable, this.el, !1) &&
          e.push(n.getAttribute(a.dataIdAttr) || $n(n));
    return e;
  },
  sort: function (e, n) {
    var o = {},
  ...
  option: function (e, n) {
    ...
    typeof r != "undefined" ? (o[e] = r) : (o[e] = n), e === "group" && Kt(o);
  },
  destroy: function () {
    N("destroy", this);
    var e = this.el;
...
function Gn(t, e, n) {
  var o = x(gt(n.el, n.options.draggable)),
    r = 10;
  return e
    ? t.clientX > o.right + r ||
...
function zn(t, e, n, o, r, i, a, l) {
  ...
  if (!a) {
    if (l && He < u * r) {
      if (
        (!Pe &&
          (Ae === 1 ? s > c + (u * i) / 2 : s < f - (u * i) / 2) &&
          (Pe = !0),
        Pe)
      )
        m = !0;
      else if (Ae === 1 ? s < c + He : s > f - He) return -Ae;
...
p.mount = function () {
  ...
  e[0].constructor === Array && (e = e[0]),
    e.forEach(function (o) {
      ...
      o.utils && (p.utils = U(U({}, p.utils), o.utils)), Fe.mount(o);
    });
};
...
function Kn() {
  ...
  return (
    (t.prototype = {
      ...
      nulling: function () {
        (qe = ht = Ce = pt = xe = at = lt = null), (C.length = 0);
      },
      ...
      _handleAutoScroll: function (n, o) {
        ...
        if (
          ((qe = n), o || this.options.forceAutoScrollFallback || Ne || Q || Te)
        ) {
          st(n, this.options, l, o);
          var s = re(l, !0);
          pt &&
            (!xe || i !== at || a !== lt) &&
            (xe && kt(),
            (xe = setInterval(function () {
              ...
              u !== s && ((s = u), We()), st(n, r.options, u, o);
            }, 10)),
            (at = i),
            (lt = a));
        } else {
          if (!this.options.bubbleScroll || re(l, !0) === z()) {
            We();
            return;
          }
          st(n, this.options, re(l, !1), !1);
        }
      }
    }),
    J(t, { pluginName: "scroll", initializeByDefault: !0 })
  );
}
function We() {
          ...
          ? ((ie =
            ...
            (W =
              ...
              (F.overflowY === "auto" ||
                ...
                F.overflowY === "visible")))
          : ((ie =
              Y < ae && (F.overflowX === "auto" || F.overflowX === "scroll")),
            (W =
              j < ve && (F.overflowY === "auto" || F.overflowY === "scroll")));
        var we =
            ie &&
            (Math.abs(A - r) <= a && be + Y < ae) -
              (Math.abs($ - r) <= a && !!be),
          q =
            W &&
            (Math.abs(B - i) <= a && ee + j < ve) -
              (Math.abs(y - i) <= a && !!ee);
        if (!C[f]) for (var le = 0; le <= f; le++) C[le] || (C[le] = {});
        (C[f].vx != we || C[f].vy != q || C[f].el !== w) &&
          ((C[f].el = w),
          (C[f].vx = we),
          (C[f].vy = q),
          ...
          (we != 0 || q != 0) &&
            ...
            (C[f].pid = setInterval(
              function () {
                o && this.layer === 0 && p.active._onTouchMove(qe);
                var _e = C[this.layer].vy ? C[this.layer].vy * l : 0,
                  te = C[this.layer].vx ? C[this.layer].vx * l : 0;
                (typeof c == "function" &&
                  c.call(
...
const eo = /-(\w)/g,
  to = Qn(t => t.replace(eo, (e, n) => n.toUpperCase())),
  en = ["Start", "Add", "Remove", "Update", "End"],
  tn = ["Choose", "Unchoose", "Sort", "Filter", "Clone"],
  nn = ["Move"],
  no = [nn, en, tn].flatMap(t => t).map(t => `on${t}`),
  mt = { manage: nn, manageAndEmit: en, emit: tn };
function oo(t) {
...
function lo({ $attrs: t, componentData: e = {} }) {
  const n = rn(Object.entries(t).filter(([o, r]) => on(o)));
  return K(K({}, n), e);
}
function so({ $attrs: t, callBackBuilder: e }) {
  const n = rn(an(t));
...
const Rt = ({ el: t }) => t,
  uo = (t, e) => (t.__draggable_context = e),
  Xt = t => t.__draggable_context;
class co {
  constructor({
...
function ho({ $slots: t, realList: e, getKey: n }) {
  const o = e || [],
    [r, i] = ["header", "footer"].map(s => fo(t, s)),
    { item: a } = t;
  ...
  const l = o.flatMap((s, u) =>
    a({ element: s, index: u }).map(
      c => (
        (c.key = n(s)),
        (c.props = Ee(K({}, c.props || {}), { "data-draggable": !0 })),
        c
      )
    )
  );
...
function po(t) {
  const e = ao(t),
    n = !io(t) && !e;
  return { transition: e, externalComponent: n, tag: n ? De(t) : e ? vn : t };
}
function mo({ $slots: t, tag: e, realList: n, getKey: o }) {
  const r = ho({ $slots: t, realList: n, getKey: o }),
    i = po(e);
  return new co({ nodes: r, root: i, realList: n });
}
function ln(t, e) {
...
function go(t) {
  ...
  return (n, o) => {
    e.call(this, n, o), ln.call(this, t, n);
  };
}
let dt = null;
const vo = {
  ...
  bo = [
    "update:modelValue",
    "change",
    ...[...mt.manageAndEmit, ...mt.emit].map(t => t.toLowerCase())
  ],
  Bt = Yt({
    name: "draggable",
    inheritAttrs: !1,
    ...
    render() {
      try {
        ...
        const {
          ...
          a = mo({ $slots: t, tag: n, realList: r, getKey: i });
        this.componentStructure = a;
        const l = lo({ $attrs: e, componentData: o });
        return a.render(Dt, l);
      } catch (t) {
        return (
          (this.error = !0), Dt("pre", { style: { color: "red" } }, t.stack)
        );
      }
    },
    created() {
    ...
    mounted() {
      ...
      const o = so({
          $attrs: t,
          callBackBuilder: {
            manageAndEmit: i => go.call(this, i),
            emit: i => ln.bind(this, i),
            manage: i => sn.call(this, i)
          }
        }),
    ...
    methods: {
      ...
      onDragRemove(t) {
        if ((Lt(this.$el, t.item, t.oldIndex), t.pullMode === "clone")) {
          ut(t.clone);
          return;
        }
      ...
      onDragUpdate(t) {
        ut(t.item), Lt(t.from, t.item, t.oldIndex);
      ...
      computeFutureIndex(t, e) {
        ...
        return n.indexOf(dt) !== -1 || !e.willInsertAfter ? r : r + 1;
      },
      onDragMove(t, e) {
        ...
        const r = this.getRelatedContextFromMoveEvent(t),
          ...
          a = Ee(K({}, this.context), { futureIndex: i }),
          l = Ee(K({}, t), { relatedContext: r, draggedContext: a });
        return n(l, e);
      },
      onDragEnd() {
        dt = null;
  ...
  wo = { class: "card-header" },
  _o = { class: "font-medium" },
  yo = { class: "drag-container" },
  Eo = { class: "item-single" },
  Do = { class: "cut-container" },
  So = Yt({
    name: "Draggable",
    __name: "draggable",
    setup(t) {
      const { setSortSwap: e } = xt(),
        n = Ze([
          { grid: "cn", num: 1 },
          { grid: "cn", num: 2 },
          { grid: "cn", num: 3 },
      ...
      return (
        bn(() => {
          xt().sortSwap || Et.mount(new gn()),
            e(!0),
            new Et(document.querySelector(".cut-container"), {
              swap: !0,
              forceFallback: !0,
              chosenClass: "chosen",
              swapClass: "highlight",
                    ...
                    },
                    {
                      default: I(
                        () =>
                          l[4] ||
                          (l[4] = [
                            Qe(" 代码位置 src/views/able/draggable.vue ")
                          ])
                      ),
                      _: 1,
                      __: [4]
                                        ...
                                        Ct(
                                          ...
                                          yn(
                                            ...
                                            (m, w) => (
                                              ...
                                              Ct(
                                                "div",
                                                { key: w, class: "item-cut" },
                                                [M("p", null, ke(m.name), 1)]
                                              )
                                            )
                                          ),
                                          128
  ...
  Ao = Dn(So, [["__scopeId", "data-v-97efa29c"]]);
