...
var k = { lastBuildTime: "2025-09-29 14:22:53" };
const B = { class: "flex" },
  C = { class: "p-6 w-[90%] m-auto bg-[#fafafa] dark:bg-[#1d1d1d]" },
  y = f({
    name: "Success",
    __name: "success",
    setup(D) {
      const { lastBuildTime: r } = k,
        c = [
          ...
          b(
            ...
            { shadow: "never" },
            {
                ...
                t(
                  ...
                  },
                  {
                    default: s(
                      () =>
                        e[0] ||
                        (e[0] = [o(" 代码位置 src/views/result/success.vue ")])
                    ),
                    _: 1,
                    __: [0]
                  }
              ...
              default: s(() => [
                    ...
                    extra: s(() => [
                      l("div", B, [
                        t(
                          ...
                          { type: "primary" },
                          {
                            default: s(() => e[2] || (e[2] = [o("返回列表")])),
                            _: 1,
                            __: [2]
                          }
                        ),
                        t(i, null, {
                          default: s(() => e[3] || (e[3] = [o("查看项目")])),
                          _: 1,
                          __: [3]
                        }),
                        t(i, null, {
                          default: s(() => e[4] || (e[4] = [o("打印")])),
                          _: 1,
                          __: [4]
                        })
                      ])
                ...
                l("div", C, [
                  t(_, { title: "项目名称", columns: c, class: "mb-5" }),
                  t(
                    p,
                    { active: 2 },
                    {
                                    ...
                                    [
                                      ...
                                      l(
                                        "span",
                                        {
                                          ...
                                          "aria-label": "dingding",
                                          class:
                                            "anticon anticon-dingding flex items-center cursor-pointer",
                                          style: {
                                            "margin-left": "8px",
                                            color: "rgb(0 160 233)"
                                          }
  ...
  S = w(y, [["__scopeId", "data-v-e38b1131"]]);
export { S as default };
