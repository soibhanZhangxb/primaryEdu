import { s as v, a as h } from "./vue-virtual-scroller.esm-BI_OJmVv.js";
import {
  d as x,
  a as r,
  p as g,
...
const k = { class: "dynamic-scroller-demo" },
  ...
  B = x({
    ...
    setup(N) {
      const i = r([]),
        a = r("");
      for (let e = 0; e < 800; e++) i.value.push({ id: e });
      const u = g(() => {
        if (!a.value) return i.value;
        const e = a.value;
        return i.value.filter(s => s.id == e);
      });
      return (e, s) => {
        const f = d("el-input"),
          _ = d("IconifyIconOnline");
        return (
          I(),
          w("div", k, [
            o("div", b, [
              s[1] || (s[1] = V(" 垂直模式 vertical ")),
              l(
                f,
                {
                  modelValue: a.value,
  ...
  S = C(B, [["__scopeId", "data-v-ffc33530"]]);
export { S as default };
