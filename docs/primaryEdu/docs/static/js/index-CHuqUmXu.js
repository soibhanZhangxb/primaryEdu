import { p as n } from "./propTypes-B9jTUFW5.js";
import {
  d as T,
  r as h,
  p as C,
    ...
    setup(a, { emit: s }) {
        ...
        (t.remaining = t.localDuration - i),
          d
            ...
            : g(u)
              ? (t.printVal =
                  t.localStartVal -
                  (t.localStartVal - e) * (i / t.localDuration))
              : (t.printVal =
                  t.localStartVal +
      ...
      function m(o) {
        ...
        const N = p.length > 1 ? c + p[1] : "",
          S = /(\d+)(\d{3})/;
        if (e && !A(e)) for (; S.test(V); ) V = V.replace(S, "$1" + e + "$2");
        return D + V + N + i;
      }
      return (
        z(() => {
