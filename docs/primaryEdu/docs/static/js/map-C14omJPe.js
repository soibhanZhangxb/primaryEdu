...
var y = (f, l, n) =>
    l in f
      ? P(f, l, { enumerable: !0, configurable: !0, writable: !0, value: n })
      : (f[l] = n),
  L = (f, l) => {
    for (var n in l || (l = {})) S.call(l, n) && y(f, n, l[n]);
    if (I) for (var n of I(l)) R.call(l, n) && y(f, n, l[n]);
    return f;
  };
import {
  R as B,
...
import { m as O } from "./mock-C8wmmSFs.js";
var h = { exports: {} },
  q = h.exports,
  b;
function K() {
      ...
      (function (f, l) {
        (function (n, w) {
          ...
          function n(e) {
            var p = [];
            return (
              e.AMapUI && p.push(w(e.AMapUI)),
              e.Loca && p.push(m(e.Loca)),
              Promise.all(p)
            );
          }
          function w(e) {
            return new Promise(function (p, t) {
              var s = [];
              if (e.plugins)
                for (var i = 0; i < e.plugins.length; i += 1)
                  o.AMapUI.plugins.indexOf(e.plugins[i]) == -1 &&
                    s.push(e.plugins[i]);
              if (u.AMapUI === a.failed) t("前次请求 AMapUI 失败");
              else if (u.AMapUI === a.notload) {
                (u.AMapUI = a.loading),
                  (o.AMapUI.version = e.version || o.AMapUI.version),
                  (i = o.AMapUI.version);
                var c = document.body || document.head,
                  A = document.createElement("script");
                (A.type = "text/javascript"),
                  (A.src = "https://webapi.amap.com/ui/" + i + "/main.js"),
                  (A.onerror = function (r) {
                    (u.AMapUI = a.failed), t("请求 AMapUI 失败");
                  }),
                  (A.onload = function () {
                    if (((u.AMapUI = a.loaded), s.length))
                      window.AMapUI.loadUI(s, function () {
                        for (var r = 0, v = s.length; r < v; r++) {
                          var U = s[r].split("/").slice(-1)[0];
                          window.AMapUI[U] = arguments[r];
                        }
                        for (p(); d.AMapUI.length; ) d.AMapUI.splice(0, 1)[0]();
                      });
                    else
                      for (p(); d.AMapUI.length; ) d.AMapUI.splice(0, 1)[0]();
                  }),
                ...
                u.AMapUI === a.loaded
                  ? e.version && e.version !== o.AMapUI.version
                    ? t("不允许多个版本 AMapUI 混用")
                    : s.length
                      ? window.AMapUI.loadUI(s, function () {
                          for (var r = 0, v = s.length; r < v; r++) {
                  ...
                  : e.version && e.version !== o.AMapUI.version
                    ? t("不允许多个版本 AMapUI 混用")
                    : d.AMapUI.push(function (r) {
                        r
                          ? t(r)
                          : s.length
                            ? window.AMapUI.loadUI(s, function () {
                                for (var v = 0, U = s.length; v < U; v++) {
                                  var E = s[v].split("/").slice(-1)[0];
                                  window.AMapUI[E] = arguments[v];
                                }
                                p();
                              })
                            : p();
          ...
          function m(e) {
            return new Promise(function (p, t) {
              if (u.Loca === a.failed) t("前次请求 Loca 失败");
              else if (u.Loca === a.notload) {
                (u.Loca = a.loading),
                  (o.Loca.version = e.version || o.Loca.version);
                var s = o.Loca.version,
                  i = o.AMap.version.startsWith("2"),
                  c = s.startsWith("2");
                if ((i && !c) || (!i && c)) t("JSAPI 与 Loca 版本不对应！！");
                else {
                  (i = o.key), (c = document.body || document.head);
                  var A = document.createElement("script");
                  (A.type = "text/javascript"),
                    (A.src =
                      "https://webapi.amap.com/loca?v=" + s + "&key=" + i),
                    (A.onerror = function (r) {
                      (u.Loca = a.failed), t("请求 AMapUI 失败");
                    }),
                    (A.onload = function () {
                      for (u.Loca = a.loaded, p(); d.Loca.length; )
                        d.Loca.splice(0, 1)[0]();
                    }),
                    c.appendChild(A);
                }
                ...
                u.Loca === a.loaded
                  ? e.version && e.version !== o.Loca.version
                    ? t("不允许多个版本 Loca 混用")
                    : p()
                  : e.version && e.version !== o.Loca.version
                    ? t("不允许多个版本 Loca 混用")
                    : d.Loca.push(function (r) {
                        r ? t(r) : t();
                      });
            });
          }
          ...
          var o = {
            ...
            u = { AMap: a.notload, AMapUI: a.notload, Loca: a.notload },
            d = { AMapUI: [], Loca: [] },
            g = [],
            M = function (e) {
              typeof e == "function" &&
                (u.AMap === a.loaded ? e(window.AMap) : g.push(e));
            };
          return {
            load: function (e) {
              return new Promise(function (p, t) {
                if (u.AMap == a.failed) t("");
                else if (u.AMap == a.notload) {
                  var s = e.key,
                    i = e.version,
                    c = e.plugins;
                  s
                    ? (window.AMap &&
                        ...
                        t("禁止多种API加载方式混用"),
                      (o.key = s),
                      (o.AMap.version = i || o.AMap.version),
                      (o.AMap.plugins = c || o.AMap.plugins),
                      (u.AMap = a.loading),
                      (i = document.body || document.head),
                      (window.___onAPILoaded = function (r) {
                        if ((delete window.___onAPILoaded, r))
                          (u.AMap = a.failed), t(r);
                        else
                          for (
                            u.AMap = a.loaded,
                      ...
                      i.appendChild(c))
                    : t("请填写key");
                } else if (u.AMap == a.loaded)
                  if (e.key && e.key !== o.key) t("多个不一致的 key");
                  else if (e.version && e.version !== o.AMap.version)
                    t("不允许多个版本 JSAPI 混用");
                  else {
                    if (((s = []), e.plugins))
                      for (i = 0; i < e.plugins.length; i += 1)
                        o.AMap.plugins.indexOf(e.plugins[i]) == -1 &&
                          s.push(e.plugins[i]);
                    s.length
                ...
                else if (e.key && e.key !== o.key) t("多个不一致的 key");
                else if (e.version && e.version !== o.AMap.version)
                  t("不允许多个版本 JSAPI 混用");
                else {
                  var A = [];
...
const V = B(Q),
  ...
  H = x({
    ...
    setup(f) {
      ...
      return (
        Y(() => {
          if (!w) return;
          const { MapConfigure: o } =
              w.appContext.config.globalProperties.$config,
            { options: u } = o;
          V.load({
            key: o.amapKey,
            version: "2.0",
            ...
            .then(d => {
              (n = new d.Map(w.refs.mapview, u)),
                n.plugin(["AMap.ToolBar", "AMap.MapType"], () => {
                  n.addControl(new d.ToolBar()),
                    n.addControl(new d.MapType({ defaultType: 0 }));
                }),
                (l = new d.MarkerCluster(n, [], {
                  gridSize: 80,
                  maxZoom: 14,
                  renderMarker(g) {
                    const { marker: M, data: e } = g;
                    if (Array.isArray(e) && e[0]) {
                      const {
                        ...
                        i = `<img style="transform: scale(1) rotate(${360 - Number(s)}deg);" src='${X}' />`;
                      M.setContent(i),
                        M.setLabel({
                          direction: "bottom",
                        ...
                        M.setOffset(new d.Pixel(-18, -10)),
                        M.on("click", ({ lnglat: c }) => {
                          n.setZoom(13), n.setCenter(c);
                        });
                    }
                  }
                })),
                O()
                  .then(({ data: g }) => {
                    const M = g.map(e => L({ lnglat: [e.lng, e.lat] }, e));
                    l && l.setData(M);
                  })
                  .catch(g => {}),
                a();
            ...
            .catch(() => {
              throw ((m.loading = !1), "地图加载失败，请重新加载");
            });
        }),
        J(() => {
          n && n.destroy() && n.clearEvents("click");
        }),
        (o, u) => {
          const d = W("loading");
          return j((k(), z("div", G, null, 512)), [[d, m.loading]]);
        }
      );
    }
  }),
  $ = C(H, [["__scopeId", "data-v-2ac3e490"]]),
  ee = N($),
  ne = x({
    name: "MapPage",
    __name: "map",
  ...
  ie = C(ne, [["__scopeId", "data-v-3dc552d8"]]);
