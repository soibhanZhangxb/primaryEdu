import { useColumns as g } from "./columns-psFIIdpG.js";
import {
  k as s,
  e as a,
  g as c,
...
import { u as d } from "./hooks-DNx1M7hz.js";
import { D as b } from "./delete-DeDT0XGg.js";
...
const B = { render: V },
  D = { viewBox: "0 0 1024 1024", width: "1em", height: "1em" };
function H(r, o) {
  return (
    a(),
    s(
...
const M = w({ name: "ep-plus", render: H }),
  $ = { class: "flex" },
  z = { class: "w-[400px]" },
  N = x({
    __name: "index",
    setup(r) {
      const { columns: o, dataList: i, onAdd: _, onDel: u } = g();
      return (A, m) => {
        const h = l("el-scrollbar"),
          p = l("el-button"),
          f = l("pure-table");
        return (
          a(),
  ...
  T = C(N, [["__scopeId", "data-v-215044a7"]]);
export { T as default };
