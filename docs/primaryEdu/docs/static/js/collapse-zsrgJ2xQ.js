import { k as t, e as n, g as r } from "./index-ifxKUhWa.js";
const a = {
  width: "32",
  height: "32",
  fill: "currentColor",
...
const x = { render: l },
  i = { width: "32", height: "32", viewBox: "0 0 24 24" };
function s(o, e) {
  return (
    n(),
    t(
...
const p = { render: s },
  d = { width: "32", height: "32", viewBox: "0 0 24 24" };
function c(o, e) {
  return (
    n(),
    t(
...
const w = { render: c },
  h = { width: "32", height: "32", viewBox: "0 0 24 24" };
function u(o, e) {
  return (
    n(),
    t(
...
const M = { render: u },
  v = { width: "32", height: "32", viewBox: "0 0 24 24" };
function g(o, e) {
  return (
    n(),
    t(
...
const m = { render: g };
export { m as C, x as D, p as E, w as R, M as S };
