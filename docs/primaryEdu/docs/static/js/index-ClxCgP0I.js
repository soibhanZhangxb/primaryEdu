    ...
    return (
      ...
      (function (e) {
        ...
        if (i.some(s => s > 1 || s < -1)) {
          ...
          for (const r of e) for (let o = 0; o < s; o++) r[o] /= n;
        }
      })(p),
      {
        duration: t,
        ...
        getChannelData: e => (p == null ? void 0 : p[e]),
...
var et = Object.freeze({ __proto__: null, createElement: J, default: J });
const it = {
        ...
        (function (s, n) {
          C(this, void 0, void 0, function* () {
            ...
            const r = s.body.getReader(),
              o = Number(s.headers.get("Content-Length")) || 0;
            let c = 0;
            const l = d =>
                C(this, void 0, void 0, function* () {
                  c += (d == null ? void 0 : d.length) || 0;
                  const h = Math.round((c / o) * 100);
                  n(h);
                }),
              a = () =>
                C(this, void 0, void 0, function* () {
...
class W extends O {
    ...
    this.subscriptions.push(
      (function (t, e, i, s, n = 3, r = 0, o = 100) {
          ...
          const S = Date.now(),
            f = g => {
              ...
              const E = g.clientX,
                ...
                _ = E - h,
                T = P - u;
              if (m || Math.abs(_) > n || Math.abs(T) > n) {
                const D = t.getBoundingClientRect(),
                  { left: F, top: U } = D;
                m || (i == null || i(h - F, u - U), (m = !0)),
                  e(_, T, E - F, P - U),
                  (h = E),
                  (u = P);
              }
            ...
            b = g => {
              (g.relatedTarget &&
                g.relatedTarget !== document.documentElement) ||
                v(g);
            },
            w = g => {
        ...
        return (
          ...
          () => {
            l(), t.removeEventListener("pointerdown", a);
          }
        );
      })(
        this.wrapper,
  ...
  getHeight(t, e) {
    ...
    if (t === "auto") {
      ...
      return e != null && e.every(r => !r.overlay) ? n / s : n;
    }
    return 128;
  }
  initHtml() {
  ...
  renderBarWaveform(t, e, i, s) {
    const n = t[0],
      r = t[1] || t[0],
      o = n.length,
      { width: c, height: l } = i.canvas,
      a = l / 2,
      d = this.getPixelRatio(),
      h = e.barWidth ? e.barWidth * d : 1,
      u = e.barGap ? e.barGap * d : e.barWidth ? h / 2 : 0,
      m = e.barRadius || 0,
      S = c / (h + u) / o,
      f = m && "roundRect" in i ? "roundRect" : "rect";
    i.beginPath();
    let v = 0,
      b = 0,
      w = 0;
    for (let x = 0; x <= o; x++) {
      const g = Math.round(x * S);
      if (g > v) {
        const _ = Math.round(b * a * s),
          T = _ + Math.round(w * a * s) || 1;
        let D = a - _;
        e.barAlign === "top" ? (D = 0) : e.barAlign === "bottom" && (D = l - T),
          i[f](v * (h + u), D, h, T, m),
          (v = g),
          (b = 0),
          (w = 0);
      }
      const E = Math.abs(n[x] || 0),
        P = Math.abs(r[x] || 0);
      E > b && (b = E), P > w && (w = P);
    }
    i.fill(), i.closePath();
  ...
  renderLineWaveform(t, e, i, s) {
    const n = r => {
      ...
      let h = 0,
        u = 0;
      for (let m = 0; m <= c; m++) {
        const S = Math.round(m * d);
        if (S > h) {
          const v = a + (Math.round(u * a * s) || 1) * (r === 0 ? -1 : 1);
          i.lineTo(h, v), (h = S), (u = 0);
        }
        const f = Math.abs(o[m] || 0);
        f > u && (u = f);
      }
      i.lineTo(h, a);
    };
  ...
  renderWaveform(t, e, i) {
    ...
    let s = e.barHeight || 1;
    if (e.normalize) {
      const n = Array.from(t[0]).reduce((r, o) => Math.max(r, Math.abs(o)), 0);
      s = n ? 1 / n : 1;
    }
  ...
  renderSingleCanvas(t, e, i, s, n, r, o) {
    const c = this.getPixelRatio(),
      l = document.createElement("canvas");
    (l.width = Math.round(i * c)),
      (l.height = Math.round(s * c)),
      (l.style.width = `${i}px`),
      (l.style.height = `${s}px`),
      (l.style.left = `${Math.round(n)}px`),
      r.appendChild(l);
    const a = l.getContext("2d");
    if ((this.renderWaveform(t, e, a), l.width > 0 && l.height > 0)) {
      const d = l.cloneNode(),
        h = d.getContext("2d");
      h.drawImage(l, 0, 0),
        (h.globalCompositeOperation = "source-in"),
        (h.fillStyle = this.convertColorValues(e.progressColor)),
  ...
  renderMultiCanvas(t, e, i, s, n, r) {
    const o = this.getPixelRatio(),
      { clientWidth: c } = this.scrollContainer,
      l = i / o;
    let a = Math.min(W.MAX_CANVAS_WIDTH, c, l),
      d = {};
    if (a === 0) return;
    if (e.barWidth || e.barGap) {
      const f = e.barWidth || 0.5,
        v = f + (e.barGap || f / 2);
      a % v != 0 && (a = Math.floor(a / v) * v);
    }
    const h = f => {
        if (f < 0 || f >= u || d[f]) return;
        d[f] = !0;
        const v = f * a,
          b = Math.min(l - v, a);
        if (b <= 0) return;
        const w = t.map(x => {
          const g = Math.floor((v / l) * x.length),
            E = Math.floor(((v + b) / l) * x.length);
          return x.slice(g, E);
        });
        this.renderSingleCanvas(w, e, b, s, v, n, r);
      },
      u = Math.ceil(l / a);
    if (!this.isScrollable) {
      for (let f = 0; f < u; f++) h(f);
      return;
    }
    const m = this.scrollContainer.scrollLeft / l,
      S = Math.floor(m * u);
    if ((h(S - 1), h(S), h(S + 1), u > 1)) {
      const f = this.on("scroll", () => {
        const { scrollLeft: v } = this.scrollContainer,
          b = Math.floor((v / l) * u);
        Object.keys(d).length > W.MAX_NODES &&
    ...
    var { overlay: n } = e,
      r = (function (a, d) {
        ...
        if (a != null && typeof Object.getOwnPropertySymbols == "function") {
          var m = 0;
          for (u = Object.getOwnPropertySymbols(a); m < u.length; m++)
            d.indexOf(u[m]) < 0 &&
              Object.prototype.propertyIsEnumerable.call(a, u[m]) &&
              (h[u[m]] = a[u[m]]);
        }
        return h;
      })(e, ["overlay"]);
    const o = document.createElement("div"),
      c = this.getHeight(r.height, r.splitChannels);
    (o.style.height = `${c}px`),
      n && s > 0 && (o.style.marginTop = `-${c}px`),
      (this.canvasWrapper.style.minHeight = `${c}px`),
      this.canvasWrapper.appendChild(o);
    const l = o.cloneNode();
    this.progressWrapper.appendChild(l),
      this.renderMultiCanvas(t, r, i, c, o, l);
  }
  render(t) {
    return C(this, void 0, void 0, function* () {
      var e;
      this.timeouts.forEach(c => c()),
        (this.timeouts = []),
      ...
      if (
        ...
        for (let c = 0; c < t.numberOfChannels; c++) {
          ...
          this.renderChannel([t.getChannelData(c)], l, o, c);
        }
      else {
        const c = [t.getChannelData(0)];
        t.numberOfChannels > 1 && c.push(t.getChannelData(1)),
          this.renderChannel(c, this.options, o, 0);
      }
  ...
  scrollIntoView(t, e = !1) {
    ...
    if (this.isDragging)
      r + 30 > c
        ...
        : r - 30 < o && (this.scrollContainer.scrollLeft -= 30);
    else {
      (r < o || r > c) &&
      ...
      e &&
        ...
        a > 0 &&
        (this.scrollContainer.scrollLeft += Math.min(a, 10));
    }
    {
      const a = this.scrollContainer.scrollLeft,
        d = a / s,
        h = (a + n) / s;
      this.emit("scroll", d, h, a, a + n);
    }
  }
  renderProgress(t, e) {
    if (isNaN(t)) return;
    ...
    (this.canvasWrapper.style.clipPath = `polygon(${i}% 0, 100% 0, 100% 100%, ${i}% 100%)`),
      ...
      (this.cursor.style.transform = `translateX(-${Math.round(i) === 100 ? this.options.cursorWidth : 0}px)`),
        ...
        Array.from(s).map(
          n =>
            new Promise((r, o) => {
              n.toBlob(
                c => {
                  c ? r(c) : o(new Error("Could not export image"));
                },
                t,
                e
              );
...
(W.MAX_CANVAS_WIDTH = 8e3), (W.MAX_NODES = 10);
class nt extends O {
  constructor() {
...
class H extends O {
  ...
  stopAt(t) {
    const e = t - this.currentTime,
      i = this.bufferNode;
    i == null || i.stop(this.audioContext.currentTime + e),
      i == null ||
        i.addEventListener(
          "ended",
          () => {
...
class A extends st {
  ...
  constructor(t) {
    const e = t.media || (t.backend === "WebAudio" ? new H() : void 0);
    super({
      media: e,
      ...
      (this.options = Object.assign({}, rt, t)),
      (this.timer = new nt());
    const i = e ? void 0 : this.getMediaElement();
    (this.renderer = new W(this.options, i)),
  ...
  setOptions(t) {
    (this.options = Object.assign({}, this.options, t)),
      t.duration &&
        !t.peaks &&
        (this.decodedData = j.createBuffer(this.exportPeaks(), t.duration)),
      t.peaks &&
        t.duration &&
        (this.decodedData = j.createBuffer(t.peaks, t.duration)),
  ...
  loadAudio(t, e, i, s) {
    return C(this, void 0, void 0, function* () {
        ...
        window.AbortController &&
          ...
          (o.signal =
            (n = this.abortController) === null || n === void 0
              ? void 0
              : n.signal));
        const c = a => this.emit("loading", a);
        e = yield it.fetchBlob(t, c, o);
        const l = this.options.blobMimeType;
        l && (e = new Blob([e], { type: l }));
      }
      this.setSrc(t, e);
      const r = yield new Promise(o => {
        const c = s || this.getDuration();
        c
          ? o(c)
          : this.mediaSubscriptions.push(
              this.onMediaEvent("loadedmetadata", () => o(this.getDuration()), {
                once: !0
              })
            );
      });
      if (!t && !e) {
        ...
        o instanceof H && (o.duration = r);
      }
      if (i) this.decodedData = j.createBuffer(i, r || 0);
      else if (e) {
        const o = yield e.arrayBuffer();
        this.decodedData = yield j.decode(o, this.options.sampleRate);
      }
      this.decodedData &&
  ...
  exportPeaks({
    ...
    const s = Math.min(t, this.decodedData.numberOfChannels),
      n = [];
    for (let r = 0; r < s; r++) {
      const o = this.decodedData.getChannelData(r),
        c = [],
        l = o.length / e;
      for (let a = 0; a < e; a++) {
        const d = o.slice(Math.floor(a * l), Math.ceil((a + 1) * l));
        let h = 0;
        for (let u = 0; u < d.length; u++) {
          const m = d[u];
          Math.abs(m) > Math.abs(h) && (h = m);
        }
        c.push(Math.round(h * i) / i);
      }
      n.push(c);
    }
    return n;
...
(A.BasePlugin = class extends O {
  constructor(p) {
    super(), (this.subscriptions = []), (this.options = p);
  }
  onInit() {}
  _init(p) {
    (this.wavesurfer = p), this.onInit();
  }
  destroy() {
    this.emit("destroy"), this.subscriptions.forEach(p => p());
  }
}),
  (A.dom = et);
const ot = {
      ...
      t[0] ||
        (t[0] = [
          y(
            ...
            {
              fill: "#f56c6c",
              d: "M512 42.667C252.793 42.667 42.667 252.793 42.667 512S252.793 981.333 512 981.333 981.333 771.207 981.333 512 771.207 42.667 512 42.667M708.547 543.16l-266.667 176A37.333 37.333 0 0 1 384 688V336.033a37.333 37.333 0 0 1 57.893-31.16l266.667 176a37.333 37.333 0 0 1 0 62.32z"
            },
            null,
            -1
          )
      ...
      t[0] ||
        (t[0] = [
          y(
            ...
            {
              fill: "#409EFF",
              d: "M515.5 91.5C747.4 91.5 936 280.1 936 512S747.4 932.5 515.5 932.5 95 743.9 95 512 283.6 91.5 515.5 91.5m0-87C235.2 4.5 8 231.7 8 512s227.2 507.5 507.5 507.5S1023 792.3 1023 512 795.8 4.5 515.5 4.5"
            },
            null,
            -1
          ),
          y(
            ...
            {
              fill: "#81888f",
              d: "m337.7 450.8 84.1 61.2-84.1 61.2zm-28.8-115c-30.1 0-58.2 23.8-58.2 58.1v236.2c0 34.3 28.1 58.1 58.2 58.1 11.5 0 23.3-3.5 33.9-11.2l162.4-118.1c31.9-23.2 31.9-70.7 0-93.8L342.8 347c-10.6-7.7-22.4-11.2-33.9-11.2"
            },
            null,
            -1
          ),
          y(
            ...
            {
              fill: "#81888f",
              d: "m529.1 450.8 84.1 61.2-84.1 61.2zm-28.8-115c-30.1 0-58.2 23.8-58.2 58.1v236.2c0 34.3 28.1 58.1 58.2 58.1 11.5 0 23.3-3.5 33.9-11.2l162.4-118.1c31.9-23.2 31.9-70.7 0-93.8L534.2 347c-10.6-7.7-22.4-11.2-33.9-11.2"
            },
            null,
            -1
          ),
          y(
            ...
            {
              fill: "#81888f",
              d: "M736.8 367c-24 0-43.5 19.5-43.5 43.5v203c0 24 19.5 43.5 43.5 43.5s43.5-19.5 43.5-43.5v-203c0-24-19.5-43.5-43.5-43.5"
            },
            null,
            -1
          )
      ...
      t[0] ||
        (t[0] = [
          y(
            ...
            {
              fill: "#409EFF",
              d: "M512 90.3c231.9 0 420.5 188.6 420.5 420.5S743.9 931.3 512 931.3 91.5 742.7 91.5 510.8 280.1 90.3 512 90.3m0-87C231.7 3.3 4.5 230.5 4.5 510.8s227.2 507.5 507.5 507.5 507.5-227.2 507.5-507.5S792.3 3.3 512 3.3"
            },
            null,
            -1
          ),
          y(
            ...
            {
              fill: "#81888f",
              d: "M689.8 449.7V572l-84.1-61.2zm28.8-115.1c-11.5 0-23.3 3.5-33.9 11.2L522.3 463.9c-31.9 23.2-31.9 70.6 0 93.8l162.4 118.1c10.6 7.7 22.4 11.2 33.9 11.2 30.1 0 58.2-23.8 58.2-58.1V392.7c0-34.3-28.1-58.1-58.2-58.1"
            },
            null,
            -1
          ),
          y(
            ...
            {
              fill: "#81888f",
              d: "M498.4 449.7V572l-84.1-61.2zm28.8-115.1c-11.5 0-23.3 3.5-33.9 11.2L330.9 463.9c-31.9 23.2-31.9 70.6 0 93.8l162.4 118.1c10.6 7.7 22.4 11.2 33.9 11.2 30.1 0 58.2-23.8 58.2-58.1V392.7c0-34.3-28.1-58.1-58.2-58.1"
            },
            null,
            -1
          ),
          y(
            ...
            {
              fill: "#81888f",
              d: "M290.7 365.8c-24 0-43.5 19.5-43.5 43.5v203c0 24 19.5 43.5 43.5 43.5s43.5-19.5 43.5-43.5v-203c0-24-19.5-43.5-43.5-43.5"
            },
            null,
            -1
          )
...
const gt = { render: vt },
  bt = { VITE_PUBLIC_PATH: "/" },
  yt = { class: "card-header" },
  Ct = { class: "font-medium" },
  wt = {
    class: "w-8/12 m-auto! mt-[20px]!",
    "element-loading-background": "transparent"
  },
  xt = { class: "flex justify-between" },
  St = { class: "text-4xl mt-2!" },
  Et = { class: "text-[#81888f]" },
  Mt = { class: "flex mt-2 w-[180px] justify-around m-auto" },
  kt = Q({
    name: "Wavesurfer",
    __name: "index",
    setup(p) {
      ...
      function a() {
        (e.value = A.create({
          ...
          e.value.on("decode", () => (t.value = !1)),
          e.value.on("ready", () => {
            if (!e.value) return;
            const { decodedData: d } = e.value;
            n.value = d.duration;
            const { m: h, s: u } = Y(d.duration);
            (s.value = `${h}:${u}`), e.value.setTime(d.duration / 2);
          }),
          e.value.on("timeupdate", d => {
            if (d > n.value) return;
            const { m: h, s: u } = Y(d);
            r.value = `${h}:${u}`;
          }),
          e.value.on("play", () => (o.value = !0)),
          e.value.on("pause", () => (o.value = !1));
      }
      return (
        Z(a),
        tt(() => {
              ...
              { shadow: "never" },
              {
                  ...
                  B(
                    ...
                    },
                    {
                      default: N(
                        () =>
                          h[4] ||
                          (h[4] = [I(" 代码位置 src/views/able/wavesurfer ")])
                      ),
                      _: 1,
                      __: [4]
                    }
                ...
                default: N(() => [
                  k(
                    (M(),
                    L("div", wt, [
                      y("div", { ref_key: "wavesurferRef", ref: i }, null, 512),
                      k(
                        y(
                          "div",
                          xt,
                      ...
                      k(
                        y(
                          ...
                          [
                            k(
                              B(z(gt), { class: "cursor-pointer" }, null, 512),
                              [
                                [
                                  S,
                                  {
                            ...
                            k(
                              ...
                              L(
                                ...
                                [
                                  o.value
                                    ? k(
                                        (M(), V(z(lt), { key: 0 }, null, 512)),
                                        [[v]]
                                      )
                                    : k(
                                        (M(), V(z(dt), { key: 1 }, null, 512)),
                                        [[v]]
                                      )
                                ]
                              )),
                            ...
                            k(
                              B(z(mt), { class: "cursor-pointer" }, null, 512),
                              [
                                [
                                  S,
                                  {
