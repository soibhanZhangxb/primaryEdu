...
const C = { class: "flex flex-wrap" },
  ...
  h = L({
    ...
    setup(M) {
      function E() {
        x.get("https://xiaoxian521.github.io/hyperlink/img/pure.png", {
          responseType: "blob"
        }).then(({ data: A }) => {
          g(A, "test-data.png");
        });
        ...
        return (
          ...
          d(
            ...
            { shadow: "never" },
            {
              header: t(() => [
                e[4] ||
                  (e[4] = u("p", { class: "font-medium" }, "文件下载功能", -1)),
                o(
                  l,
                  {
                    class: "mt-2",
                  ...
                  },
                  {
                    default: t(
                      () =>
                        e[3] ||
                        (e[3] = [i(" 代码位置 src/views/able/download.vue ")])
                    ),
                    _: 1,
                    __: [3]
                  }
              ...
              default: t(() => [
                u("div", C, [
                  ...
                  o(
                    a,
                    {
                      onClick: e[1] || (e[1] = r => n(m)(H, "test-base64.png"))
                    },
                    {
                      default: t(
                        () => e[6] || (e[6] = [i(" 基于 base64 下载图片 ")])
                      ),
                      _: 1,
                      __: [6]
                    }
