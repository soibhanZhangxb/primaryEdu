var p = (r, s, t) =>
  new Promise((o, l) => {
    var u = a => {
      ...
      i = a => (a.done ? o(a.value) : Promise.resolve(a.value).then(u, m));
    i((t = t.apply(r, s)).next());
  });
import {
  r as c,
  a as d,
...
import { d as W } from "./system-CYz2Iuiu.js";
function C() {
  const r = c({ username: "" }),
    s = d([]),
    t = d(!0),
    o = c({ total: 0, pageSize: 10, currentPage: 1, background: !0 }),
    l = [
      ...
      { label: "浏览器类型", prop: "browser", minWidth: 100 },
      {
        ...
        prop: "loginTime",
        minWidth: 180,
        formatter: ({ loginTime: e }) => h(e).format("YYYY-MM-DD HH:mm:ss")
      },
  ...
  function i(e) {}
  function a(e) {
    v(`${e.username}已被强制下线`, { type: "success" }), n();
  }
  function n() {
    return p(this, null, function* () {
      t.value = !0;
      const { data: e } = yield W(b(r));
      (s.value = e.list),
        (o.total = e.total),
        (o.pageSize = e.pageSize),
        (o.currentPage = e.currentPage),
        setTimeout(() => {
          t.value = !1;
        }, 500);
    });
