import { S as c } from "./vue-json-pretty-B8_oSBeN.js";
import {
  d as m,
  r as w,
  n as l,
              ...
              { shadow: "never" },
              {
                    ...
                    },
                    {
                      default: o(
                        () =>
                          t[4] ||
                          (t[4] = [
                            n(" 代码位置 src/views/components/json-editor.vue ")
                          ])
                      ),
                      _: 1,
                      __: [4]
                ...
                default: o(() => [
                  a(
                    ...
                    {
                      data: e.data,
                      "onUpdate:data": t[0] || (t[0] = p => (e.data = p)),
                      deep: e.deep,
