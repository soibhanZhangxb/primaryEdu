...
function i0(e) {
  if (typeof ArrayBuffer == "undefined") return xr(e);
  for (
...
function os(e, t, r) {
  ...
  return (
    ...
    (s === 0
      ...
      : R0(s, e[1].length) + e[2] + "/" + e[3] + vr(f, e[4].length))
  );
}
function cs(e, t, r) {
...
var Ts = (function () {
  ...
  _e = (function () {
      ...
      var g = (function (te) {
          ...
          for (
            var Ve = (te.FullPaths.length + 3) >> 2,
              ...
              ut = ct + Q + Ve + ht,
              Ur = (ut + 127) >> 7,
              g0 = Ur <= 109 ? 0 : Math.ceil((Ur - 109) / 127);
            (ut + Ur + g0 + 127) >> 7 > Ur;
    ...
    for (
      var ae = typeof Uint8Array != "undefined",
    ...
    var v0 = ae ? new Uint16Array(512) : pr(512),
      d0 = ae ? new Uint16Array(32) : pr(32);
    if (!ae) {
    ...
    var Q0 = ae ? new Uint16Array(32768) : pr(32768),
      en = ae ? new Uint16Array(32768) : pr(32768),
      rn = ae ? new Uint16Array(128) : pr(128),
      tn = 1,
      nn = 1;
    function Di(h, m) {
      var p = Ae(h, m) + 257;
      ...
      for (
        ...
        for (;;) {
          ...
          if (((p += X & 15), (X >>>= 4), ((X >>> 8) & 255) === 0)) T[w++] = X;
            ...
            for (
              z > 0 && ((Q += sr(h, p, z)), (p += z)),
                !m && I < te && ((T = x0(T, te + 100)), (I = T.length));
              w < te;
    ...
    function sn(h, m) {
      if (h) typeof console != "undefined" && console.error(m);
    ...
    function Ii(h, m, p, g, T) {
      ...
      w & 8 &&
        ...
        (N = h.read_shift(4)),
        (k = h.read_shift(4))),
        N != m && sn(we, "Bad compressed size: " + m + " != " + N),
        k != p && sn(we, "Bad uncompressed size: " + p + " != " + k),
        p0(g, te, fe, { unsafe: !0, mt: U });
    }
    function Ni(h, m) {
      var p = m || {},
        g = [],
...
function Ze(e, t) {
  var r = e.getTime(),
    n = jt.getTime() + (e.getTimezoneOffset() - jt.getTimezoneOffset()) * 6e4;
  return (r - n) / (24 * 60 * 60 * 1e3);
}
var oa = new Date(),
  Ss = jt.getTime() + (oa.getTimezoneOffset() - jt.getTimezoneOffset()) * 6e4,
...
var bt = "foo bar bazâð£",
  pt = (ue && ((wn(bt) == _0(bt) && wn) || (En(bt) == _0(bt) && En))) || _0,
  At = ue
    ? function (e) {
...
var el = (function () {
    ...
    function s(f, o) {
      ...
      var c = Je(),
        d = a0(f, { header: 1, raw: !0, cellDates: !0 }),
        x = d[0],
        v = d.slice(1),
        E = f["!cols"] || [],
        u = 0,
  ...
  rl = (function () {
    ...
    function l(x, v) {
      v.forEach(function (E, u) {
        ...
        E.hidden
          ? (_ += "0")
          : (typeof E.width == "number" && !E.wpx && (E.wpx = e0(E.width)),
            typeof E.wpx == "number" && !E.wch && (E.wch = r0(E.wpx)),
    ...
    function f(c, d) {
      ...
      switch (d.type) {
        ...
        case "buffer":
          d.codepage == 65001
            ? (x = c.toString("utf8"))
            : (d.codepage && typeof Kt != "undefined") ||
...
function X0(e) {
  e.width
    ? ((e.wpx = e0(e.width)), (e.wch = r0(e.wpx)), (e.MDW = Fr))
    : e.wpx
      ? ((e.wch = r0(e.wpx)), (e.width = D0(e.wch)), (e.MDW = Fr))
      : typeof e.wch == "number" &&
        ((e.width = D0(e.wch)), (e.wpx = e0(e.width)), (e.MDW = Fr)),
...
var _l = [
  ...
  Tl = _r;
function Hn(e, t) {
  t || (t = B(4 * 3 + 8 * 7 + 16 * 1)), w0 || (w0 = N0(_l));
  var r = w0[e.patternType];
  r == null && (r = 40), t.write_shift(4, r);
  var n = 0;
  if (r != 40)
    for (qt({ auto: 1 }, t), qt({ auto: 1 }, t); n < 12; ++n)
      t.write_shift(4, 0);
  else {
    ...
    switch (e.t) {
      ...
      case "d":
        n && n.cellDates
          ...
          typeof e.z == "undefined" && (e.z = ye[14]);
        break;
      default:
        a = e.v;
        break;
...
function Wc(e, t, r) {
  ...
  var i = 320;
  a.hpx ? (i = t0(a.hpx) * 20) : a.hpt && (i = a.hpt * 20),
    n.write_shift(2, i),
    n.write_shift(1, 0);
  var s = 0;
  a.level && (s |= a.level),
...
function V1(e, t, r, n, a, i, s) {
  ...
  switch (
    ...
    case "str":
      return (
        a.bookSST
          ? ((f = $0(a.Strings, t.v, a.revStrings)),
            (o.t = "s"),
            (o.v = f),
  ...
  n.length && _e.utils.cfb_add(t, "/SummaryInformation", Mn(n, S0.SI, o, In)),
    (r.length || l.length) &&
      _e.utils.cfb_add(
        ...
        Mn(r, S0.DSI, f, Rn, l.length ? l : null, S0.UDI)
      );
}
function Lh(e, t) {
  var r = t || {},
...
function Gh(e, t) {
  ...
  return (
    J(n, r.biff == 4 ? 1033 : r.biff == 3 ? 521 : 9, V0(e, 16, r)),
...
function mu(e, t) {
  ...
  var a = e.FullPaths
    ...
    : e.generate(r);
  if (typeof Deno != "undefined" && typeof a == "string") {
