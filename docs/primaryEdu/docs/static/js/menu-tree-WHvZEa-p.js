...
import { u as q } from "./hooks-DNx1M7hz.js";
const D = { viewBox: "0 0 24 24", width: "1em", height: "1em" };
function E(f, t) {
  return (
    v(),
    z(
...
const S = C({ name: "ri-node-tree", render: E }),
  j = { class: "card-header" },
  K = { class: "font-medium" },
  Q = H({
    name: "MenuTree",
    ...
    setup(f) {
      const t = i(""),
        _ = i({ value: "uniqueId", children: "children" }),
        m = i(),
        k = B(M().wholeMenus, !0),
        p = N(() => T(k)),
        x = I(p.value),
        ...
        g = (n, e) => h(e.meta.title).indexOf(n) !== -1;
      return (n, e) => {
        const c = s("el-link"),
          w = s("el-input"),
          V = s("el-tree-v2"),
          ...
          P(
            ...
            { shadow: "never" },
            {
              header: a(() => [
                u("div", j, [
                  u("span", K, [
                    e[2] || (e[2] = l(" 菜单树结构（采用 Element Plus 的 ")),
                    o(
                      c,
                      {
                ...
                o(
                  ...
                  },
                  {
                    default: a(
                      () =>
                        e[4] ||
                        (e[4] = [l(" 代码位置 src/views/able/menu-tree.vue ")])
                    ),
                    _: 1,
                    __: [4]
                  }
              ...
              default: a(() => [
                ...
                o(
                  V,
                  {
                    ...
                    height: 500,
                    "filter-method": g,
                    "default-expanded-keys": r(x)
                  },
                  {
                    default: a(({ data: d }) => [
                      u("span", null, R(r(h)(d.meta.title)), 1)
                    ]),
                    _: 1
                  },
                  8,
