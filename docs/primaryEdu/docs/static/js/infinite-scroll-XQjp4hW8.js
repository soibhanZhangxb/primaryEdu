...
function ta() {
  ...
  mt = 1;
  var r = ea();
  return (hr = r && !Symbol.sham && typeof Symbol.iterator == "symbol"), hr;
}
var br, Ot;
function na() {
  if (Ot) return br;
...
var Ct;
function Ue() {
  if (Ct) return qr.exports;
  Ct = 1;
  var r = aa(),
    e = R(),
    t = ke(),
    n = "__core-js_shared__",
    a = (qr.exports = e[n] || t(n, {}));
  return (
  ...
  return (
    (_r = function (s, c) {
      ...
      var v = n(s, o),
        f;
      if (v) {
        if ((c === void 0 && (c = "default"), (f = r(v, s, c)), !e(f) || t(f)))
          return f;
  ...
  return (
    (J.f = r
      ...
      : function (v, f) {
          ...
          if (u(v, f)) return n(!e(t.f, v, f), v[f]);
        }),
    J
  );
}
  ...
  return (
    (Fr.f = r
        ...
        ? function (p, d, y) {
            if (
              ...
              g &&
                ...
                ((p[d] = y.value),
                (y = {
                  configurable: c in y ? y[c] : g[c],
                  enumerable: s in y ? y[s] : g[s],
                  writable: !1
                }));
            }
            return u(p, d, y);
      ...
      : function (p, d, y) {
          ...
          return "value" in y && (p[d] = y.value), p;
        }),
    Fr
  );
}
...
function Da() {
  ...
  return (Br = { EXISTS: a, PROPER: i, CONFIGURABLE: u }), Br;
}
var Gr, Vt;
function la() {
  if (Vt) return Gr;
...
function Fa() {
  ...
  var r = R(),
    e = C(),
    t = r.WeakMap;
  return (Kr = e(t) && /native code/.test(String(t))), Kr;
}
var kr, Wt;
function Na() {
  if (Wt) return kr;
...
function La() {
  ...
  if (r || i.state) {
    ...
    (h.get = h.get),
      ...
      (h.set = h.set),
      (f = function (l, b) {
        if (h.has(l)) throw new c(s);
        return (b.facade = l), h.set(l, b), b;
      }),
      (p = function (l) {
        return h.get(l) || {};
      }),
  ...
  return (Vr = { set: f, get: p, has: d, enforce: y, getterFor: g }), Vr;
}
var Xt;
function xa() {
  if (Xt) return Mr.exports;
  Xt = 1;
  var r = I(),
    e = P(),
    t = C(),
    ...
    q = (Mr.exports = function (l, b, S) {
      p(v(b), 0, 7) === "Symbol(" &&
        (b = "[" + d(v(b), /^Symbol\(([^)]*)\).*$/, "$1") + "]"),
        S && S.getter && (b = "get " + b),
        S && S.setter && (b = "set " + b),
        (!n(l, "name") || (i && l.name !== b)) &&
          (a ? f(l, "name", { value: b, configurable: !0 }) : (l.name = b)),
        g &&
          S &&
          n(S, "arity") &&
          l.length !== S.arity &&
          f(l, "length", { value: S.arity });
      try {
        S && n(S, "constructor") && S.constructor
          ? a && f(l, "prototype", { writable: !1 })
          : l.prototype && (l.prototype = void 0);
      } catch (E) {}
      var m = s(l);
      return (
        n(m, "source") || (m.source = y(h, typeof b == "string" ? b : "")), l
      );
    });
  return (
    ...
    n = function (a) {
      return function (i, u, o) {
        ...
        var v = e(o, c),
          f;
        if (a && u !== u) {
          for (; c > v; ) if (((f = s[v++]), f !== f)) return !0;
        } else
          for (; c > v; v++)
            if ((a || v in s) && s[v] === u) return a || v || 0;
        return !a && -1;
      };
    };
  return (Zr = { includes: n(!0), indexOf: n(!1) }), Zr;
}
var Qr, nn;
function ka() {
  if (nn) return Qr;
  ...
  return (
    (Qr = function (u, o) {
      ...
      for (; o.length > c; ) e(s, (f = o[c++])) && (~n(v, f) || i(v, f));
      return v;
    }),
    Qr
  );
...
var ee = {},
  un;
function $a() {
  return un || ((un = 1), (ee.f = Object.getOwnPropertySymbols)), ee;
}
var te, cn;
function Wa() {
  if (cn) return te;
...
function ha() {
  ...
  return (
    (ne = function (a, i, u) {
      for (var o = e(i), s = n.f, c = t.f, v = 0; v < o.length; v++) {
        var f = o[v];
    ...
    (ie = function (o, s) {
      ...
      if (
        ...
        for (y in s) {
          if (
            ((h = s[y]),
            o.dontCallGetSet ? ((q = e(d, y)), (g = q && q.value)) : (g = d[y]),
            (p = u(v ? y : c + (f ? "." : "#") + y, o.forced)),
            !p && g !== void 0)
          ) {
            if (typeof h == typeof g) continue;
            i(h, g);
          }
          (o.sham || (g && g.sham)) && t(h, "sham", !0), n(d, y, h, o);
        }
    }),
    ie
  );
...
function We() {
  ...
  var r = x(),
    e = r("toStringTag"),
    t = {};
  return (t[e] = "z"), (ye = String(t) === "[object z]"), ye;
}
var de, mn;
function He() {
  if (mn) return de;
        ...
        var F = r("Error"),
          O = y(function (T, N) {
            ...
            return (
              ...
              arguments.length > l && c(_, arguments[l]),
              _
            );
          });
        if (
...
function pi() {
  ...
  var r = We(),
    e = da(),
    t = di();
  return r || e(Object.prototype, "toString", t, { unsafe: !0 }), Mn;
}
pi();
var Kn = {},
  _e,
...
function bi() {
  ...
  return (je = t === Object.prototype ? void 0 : t), je;
}
var Ae, Vn;
function Si() {
  if (Vn) return Ae;
 ...
 */ var Jn = "[el-table-infinite-scroll]: ",
  V = ".el-scrollbar__wrap",
  Ti = {
    mounted: function (e, t, n, a) {
      var i = e.querySelector(V);
      if (!i) throw new Error("".concat(Jn).concat(V, " element not found."));
    ...
    updated: function (e) {
      Yn(e, e.querySelector(V));
    },
    unmounted: function (e) {
      for (
        var t = e.querySelector(V),
          n = arguments.length,
        ...
        a[i - 1] = arguments[i];
      X.unmounted.apply(X, [t].concat(a));
    }
  };
function Yn(r, e) {
  Ii(r, e, [
 ...
 * el-table-infinite-scroll v3.0.6
 * (c) 2019-2024 yujinpan
 */ var Oa = Object.assign(Ti, {
  install: function (e) {
    e.directive("el-table-infinite-scroll", Oa);
  }
});
    ...
    setup(r) {
      const e = new Array(10).fill({
        ...
        u = () => {
          i.value ||
            (n.value++,
            n.value <= a.value && (t.value = t.value.concat(e)),
            n.value === a.value && (i.value = !0));
        };
      return (o, s) => {
        const c = U("el-link"),
          v = U("el-table-column"),
            ...
            { shadow: "never" },
            {
                  ...
                  },
                  {
                    default: B(
                      () =>
                        s[1] ||
                        (s[1] = [
                          Ze(" 代码位置 src/views/able/infinite-scroll.vue ")
                        ])
                    ),
                    _: 1,
                    __: [1]
              ...
              default: B(() => [
                Ye(
                  "div",
                  Pi,
                  Ia(i.value ? "已加载全部页" : `加载到第 ${n.value} 页`),
                  1
                ),
                Ea(
                  (Je(),
                  Xe(
                    ...
                    {
                      default: B(() => [
                        L(v, { width: "80", type: "index", label: "序号" }),
                        L(v, { prop: "date", label: "日期" }),
                        L(v, { prop: "name", label: "名称" }),
                        L(v, { prop: "age", label: "年龄" })
                      ]),
                      _: 1
                    },
                    8,
