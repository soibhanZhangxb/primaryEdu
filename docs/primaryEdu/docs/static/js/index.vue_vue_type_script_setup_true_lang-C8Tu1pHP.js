import { useColumns as i } from "./columns-CPiEDCKc.js";
import {
  a1 as u,
  k as _,
  e as t,
...
const x = { viewBox: "0 0 24 24", width: "1em", height: "1em" };
function V(r, e) {
  return (
    t(),
    _(
...
const H = u({ name: "ri-calendar-2-line", render: V }),
  z = { class: "flex items-center" },
  B = d({
    __name: "index",
    setup(r) {
      const { columns: e, filterTableData: c } = i();
      return (C, o) => {
        ...
        return (
          ...
          f(
            m,
            { data: n(c), columns: n(e) },
            {
              nameHeader: h(() => [
                s("span", z, [
                  v(l, { icon: n(H) }, null, 8, ["icon"]),
                  o[0] || (o[0] = p(" 日期 "))
                ])
              ]),
              _: 1
