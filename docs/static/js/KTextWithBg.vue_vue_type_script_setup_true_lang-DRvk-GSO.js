...
var p = (o, e, t) =>
    e in o
      ? b(o, e, { enumerable: !0, configurable: !0, writable: !0, value: t })
      : (o[e] = t),
  _ = (o, e) => {
    for (var t in e || (e = {})) N.call(e, t) && p(o, t, e[t]);
    if (x) for (var t of x(e)) R.call(e, t) && p(o, t, e[t]);
    return o;
  },
  v = (o, e) => w(o, z(e));
import {
      ...
      d = () => {
        A(() => {
          ...
          const n = l.value.getNode(),
            ...
            f = n.width(),
            r = n.height();
          s.width(f + t.padding * 2),
            s.height(r + t.padding * 2),
            n.x(t.padding),
            n.y(t.padding);
        });
      },
      ...
      (n, s) => {
        ...
        return (
          ...
          W(
            ...
            {
              default: T(() => [
                m(f, { ref_key: "bgRect", ref: c, config: y.value }, null, 8, [
                  "config"
                ]),
                m(
                  r,
